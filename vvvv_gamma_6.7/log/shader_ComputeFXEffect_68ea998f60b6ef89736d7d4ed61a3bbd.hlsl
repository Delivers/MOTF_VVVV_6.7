...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_1393269104]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_1393269104 => d8c4ff7803cd8a269d71d9760f04e1ed
...
// TextureInput_383085057_id24       texture  float4          3d             t0      1 
...
//
#line 178 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_68ea998f60b6ef89736d7d4ed61a3bbd.hlsl"
...
#line 197
  mov r1.w, l(1.000000)
  dp4 r2.x, r1.xyzw, cb0[2].xyzw  // r2.x <- mul_1341085824.x
  dp4 r2.y, r1.xyzw, cb0[3].xyzw  // r2.y <- mul_1341085824.y
  dp4 r2.z, r1.xyzw, cb0[4].xyzw  // r2.z <- mul_1341085824.z

#line 199
  add r2.xyz, r2.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r2.x <- result_226465574.x; r2.y <- result_226465574.y; r2.z <- result_226465574.z

#line 200
  sample_l_indexable(texture3d)(float,float,float,float) r2.xyz, r2.xyzx, t0.xyzw, s0, l(0.000000)  // r2.x <- textureNode_3686992883.x; r2.y <- textureNode_3686992883.y; r2.z <- textureNode_3686992883.z
...
#line 230
  mov r3.w, l(1.000000)
  dp4 r4.x, r3.xyzw, cb0[12].xyzw  // r4.x <- mul_2_1341085824.x
  dp4 r4.y, r3.xyzw, cb0[13].xyzw  // r4.y <- mul_2_1341085824.y
  dp4 r4.z, r3.xyzw, cb0[14].xyzw  // r4.z <- mul_2_1341085824.z

#line 232
  add r3.xyz, r4.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r3.x <- result_2_226465574.x; r3.y <- result_2_226465574.y; r3.z <- result_2_226465574.z

#line 233
  sample_l_indexable(texture3d)(float,float,float,float) r3.xyz, r3.xyzx, t0.xyzw, s1, l(0.000000)  // r3.x <- textureNode_2_3686992883.x; r3.y <- textureNode_2_3686992883.y; r3.z <- textureNode_2_3686992883.z
...
Texture3D<float4> TextureInput_383085057_id24;
