...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Liquish_Internal_TextureFX [{ColorA = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {ColorB = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {ColorC = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}, {Scale = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {Time = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
//
#line 236 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_258063eecb763b8df5839b05ab4144c0.hlsl"
...
@G    Pixel => bc9ee1b04273e01abd0d5842ffb47bf8
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id95;            // Offset:   48 Size:     8
//   float InputValue_id96;             // Offset:   56 Size:     4
//
// }
//
//
...
//
#line 201 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_258063eecb763b8df5839b05ab4144c0.hlsl"
...
float4 Shading_id33(inout PS_STREAMS streams)
{
    ...
    float2 q;
    float2 r;
    float2 c = uv.xy * Compute_id35();
    float f = pattern_id32(c, q, r);
    float4 colorA = Compute_id36();
    float4 colorB = Compute_id37();
    float4 colorC = Compute_id38();
    float3 colors[3];
