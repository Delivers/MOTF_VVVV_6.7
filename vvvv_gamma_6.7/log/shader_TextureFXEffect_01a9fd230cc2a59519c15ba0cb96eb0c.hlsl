...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin AddonCrop_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    TopLeft_id94 => AddonCrop_Internal_TextureFX.TopLeft
@C    Size_id95 => AddonCrop_Internal_TextureFX.Size
@C    Mode_id96 => AddonCrop_Internal_TextureFX.Mode
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    AddonCrop_Internal_TextureFX => 4c25b6fee1ade0f4c27cd90e83ce4c9a
...
//
#line 264 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_01a9fd230cc2a59519c15ba0cb96eb0c.hlsl"
...
@G    Pixel => 3b998b2005bc8401567d55c35d8d10ce
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 TopLeft_id94;               // Offset:   80 Size:     8
//   float2 Size_id95;                  // Offset:   88 Size:     8
//   uint Mode_id96;                    // Offset:   96 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 243 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_01a9fd230cc2a59519c15ba0cb96eb0c.hlsl"
...
#line 226
mad r1.xyzw, v1.xyxy, cb1[5].zwzw, cb1[5].xyxy  // r1.z <- uv.x; r1.w <- uv.y
...
#line 231
  sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.zwzz, t0.xyzw, s0  // r2.x <- <Filter_id44 return value>.x; r2.y <- <Filter_id44 return value>.y; r2.z <- <Filter_id44 return value>.z; r2.w <- <Filter_id44 return value>.w
  mov r3.x, l(-1)
  break 
...
{
    float2 uv = streams.TexCoord_id62 * Size_id95 + TopLeft_id94;
    switch (Mode_id96)

    {
        ...
        case 2:
            return SampleCubicBSpline_id31(Texture0_id14, LinearSampler_id44, uv);
        case 3:
            return SampleCubicCatmullRom_id36(Texture0_id14, LinearSampler_id44, uv);
    }
    return 1;
}
