...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Twirl_Internal_TextureFX [{Angle = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Center = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Radius = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}]
@P Angle: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
...
@R    LinearMirrorSampler_id91 => Twirl_Internal_TextureFX.LinearMirrorSampler [Stage: Pixel, Slot: (1-1)]
...
*****     Sources     *****
***************************
@S    Twirl_Internal_TextureFX => 1484746b354beeb6bdba642f0e23f8c2
...
//
#line 197 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_721afa090c9c54a73c361707d4486578.hlsl"
...
@G    Pixel => 0dcf3e06ffebdc9b7fe859970161a489
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id94;            // Offset:   20 Size:     8
//   float InputValue_id95;             // Offset:   28 Size:     4
//
// }
//
// cbuffer PerView
...
// LinearMirrorSampler_id91          sampler      NA          NA             s1      1 
...
//
#line 167 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_721afa090c9c54a73c361707d4486578.hlsl"
add r0.xy, cb0[1].yzyy, l(0.500000, 0.500000, 0.000000, 0.000000)  // r0.x <- center.x; r0.y <- center.y

#line 168
add r0.zw, -r0.xxxy, v1.xxxy  // r0.z <- uv.x; r0.w <- uv.y
...
#line 169
div r2.x, cb1[1].x, cb1[1].y
mov r2.y, l(1.000000)
mul r1.yz, r0.zzwz, r2.xxyx
...
#line 171
sqrt r0.zw, r0.zzzw  // r0.w <- len; r0.z <- radius

#line 170
add r0.w, r0.w, -cb0[1].w
div r1.y, l(1.000000, 1.000000, 1.000000, 1.000000), -cb0[1].w
mul_sat r0.w, r0.w, r1.y
mad r1.y, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mul r0.w, r0.w, r1.y
mad r0.w, cb0[1].x, r0.w, r1.x  // r0.w <- angle
...
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t0.xyzw, s1, l(0.000000)  // r0.x <- <Filter_id29 return value>.x; r0.y <- <Filter_id29 return value>.y; r0.z <- <Filter_id29 return value>.z; r0.w <- <Filter_id29 return value>.w
...
SamplerState LinearMirrorSampler_id91 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Mirror;
    AddressV = Mirror;
...
{
    float effectRadius = Compute_id31();
    float effectAngle = Compute_id32();
    float2 center = Compute_id33() + 0.5;
    float2 uv = streams.TexCoord_id62 - center;
    float len = length(uv * float2(ViewSize_id77.x / ViewSize_id77.y, 1.));
    float angle = atan2(uv.y, uv.x) + effectAngle * smoothstep(effectRadius, 0.0, len);
    float radius = length(uv);
    return Texture0_id14.SampleLevel(LinearMirrorSampler_id91, float2(radius * cos(angle), radius * sin(angle)) + center, 0);
}
