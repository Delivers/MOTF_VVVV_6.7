...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_41670074]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_41670074 => 1e35ff555834082cfafd43755e8870dc
...
// TextureInput_2597306058_id24      texture  float4          3d             t0      1 
...
//
#line 168 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_839fe7b39f4b1c97dd69d7aa7ac52901.hlsl"
...
#line 187
  mov r1.w, l(1.000000)
  dp4 r2.x, r1.xyzw, cb0[2].xyzw  // r2.x <- mul_1047838218.x
  dp4 r2.y, r1.xyzw, cb0[3].xyzw  // r2.y <- mul_1047838218.y
  dp4 r2.z, r1.xyzw, cb0[4].xyzw  // r2.z <- mul_1047838218.z

#line 189
  add r2.xyz, r2.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r2.x <- result_2032950884.x; r2.y <- result_2032950884.y; r2.z <- result_2032950884.z

#line 190
  sample_l_indexable(texture3d)(float,float,float,float) r2.xyz, r2.xyzx, t0.xyzw, s0, l(0.000000)  // r2.x <- textureNode_3892032875.x; r2.y <- textureNode_3892032875.y; r2.z <- textureNode_3892032875.z
...
Texture3D<float4> TextureInput_2597306058_id24;
