...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_774967589]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_774967589 => 3a31a276890025418f0e97c1c71f96fd
...
//
#line 84 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_55d37575e735cb30b039032417445a31.hlsl"
...
RWStructuredBuffer<Resource6496307> DynamicBufferInput_4252052980_id12;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource6496307 getBuffer_3291917120 = DynamicBufferInput_4252052980_id12[IndexX_2632966837];
