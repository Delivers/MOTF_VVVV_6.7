...
@P   - AmbientOcclusionRawAO.Count: 16
...
//
#line 226 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_AmbientOcclusionRawAOEffect_ac6553ab9b2fabd8214a39662b220ea9.hlsl"
...
@G    Pixel => 2df78fd362c9d1ff369e08f04f525474
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 180 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_AmbientOcclusionRawAOEffect_ac6553ab9b2fabd8214a39662b220ea9.hlsl"
...
#line 157
  mad r5.x, r5.x, l(1.855503), r1.x  // r5.x <- angle

#line 158
  sincos r5.x, r6.x, r5.x  // r5.x <- offset.y; r6.x <- offset.x

#line 159
  mul r5.y, r5.y, l(0.042188)  // r5.y <- ssRadius
...
mad r0.x, -r0.x, l(0.312500), l(1.000000)
...
***************************
*************************/
const static int SamplesCount_id79 = 16;
