...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Circle_Reveal_Internal_TextureFX [{Fader = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Fuzzy = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Fuzzy: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
...
*****     Sources     *****
***************************
@S    Circle_Reveal_Internal_TextureFX => 1c9714fdfc5a091ce4ed571357dc9b1f
...
//
#line 188 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_0aa5cd44d9295b616c51672837fda485.hlsl"
...
@G    Pixel => f573bbe62b5b266684a15f576686eab0
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 149 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_0aa5cd44d9295b616c51672837fda485.hlsl"
add r0.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
dp2 r0.x, r0.xyxx, r0.xyxx
sqrt r0.x, r0.x  // r0.x <- fromCenter

#line 148
mad r0.y, cb0[0].y, l(2.000000), l(0.707107)
mad r0.y, cb0[0].x, r0.y, -cb0[0].y  // r0.y <- radius

#line 150
add r0.x, -r0.y, r0.x  // r0.x <- distFromCircle

#line 153
add r0.x, r0.x, cb0[0].y

#line 148
add r0.y, cb0[0].y, cb0[0].y

#line 153
div_sat r0.x, r0.x, r0.y  // r0.x <- p
...
float4 Mix_id29(inout PS_STREAMS streams, float4 tex0col, float4 tex1col, float fader)
{
    ...
    float fuzzyAmount = Compute_id31();
