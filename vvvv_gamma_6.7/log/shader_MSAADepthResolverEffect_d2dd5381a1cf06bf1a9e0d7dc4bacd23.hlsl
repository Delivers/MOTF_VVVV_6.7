...
//
#line 154 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_MSAADepthResolverEffect_d2dd5381a1cf06bf1a9e0d7dc4bacd23.hlsl"
mov o0.xyzw, v0.xyzw
mov o1.xyzw, v0.xyzw
ret 
...
//
#line 125 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_MSAADepthResolverEffect_d2dd5381a1cf06bf1a9e0d7dc4bacd23.hlsl"
mad r0.xy, v1.xyxx, cb0[5].xyxx, cb0[5].zwzz
ftoi r0.xy, r0.xyxx  // r0.x <- <ClipPosToUvPos_id17 return value>.x; r0.y <- <ClipPosToUvPos_id17 return value>.y
...
int2 ClipPosToUvPos_id17(float2 clipPos)
{
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    float4 output = 0;
    int2 pixelPos = ClipPosToUvPos_id17(streams.Position_id73.xy);
