...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Levels_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {fromBlack = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {fromWhite = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {toBlack = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}, {toWhite = InputFloat4<ShaderFX.InputValueFloat4_Color.i3,PerUpdate>}]
...
@C    InputValue_id97 => ShaderFX.InputValueFloat4_Color.i2
@C    InputValue_id98 => ShaderFX.InputValueFloat4_Color.i3
...
*****     Sources     *****
***************************
@S    Levels_TextureFX => 5640f0a77cdd93d0f878243086d47e80
...
//
#line 234 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_cce09c325669dbd93e9e0cac14d6ae71.hlsl"
...
@G    Pixel => 1ad730bae06aeea0bed717cee4b93d81
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id97;            // Offset:   48 Size:    16
...
//   float Gamma_id93;                  // Offset:   84 Size:     4
//      = 0x3f800000 
//
// }
//
...
//
#line 213 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_cce09c325669dbd93e9e0cac14d6ae71.hlsl"
...
log r1.xyzw, |r1.xyzw|
mul r1.xyzw, r1.xyzw, cb1[5].yyyy
exp r1.xyzw, r1.xyzw
...
#line 208
add r2.xyzw, -cb0[3].xyzw, cb0[4].xyzw
mad r1.xyzw, r1.xyzw, r2.xyzw, cb0[3].xyzw
...
{
    float4 fb = Compute_id35();
    float4 fw = Compute_id36();
    float4 tb = Compute_id37();
    float4 tw = Compute_id38();
    float4 c = tex0col;
