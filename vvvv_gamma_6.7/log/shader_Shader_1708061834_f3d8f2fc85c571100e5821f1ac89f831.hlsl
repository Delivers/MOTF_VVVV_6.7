...
***** Compiler Parameters *****
***************************
@P EffectName: Shader_1708061834
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Shader_1708061834 => 30f3c154fa914833d7b2f606d7d40858
...
//
#line 66 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_1708061834_f3d8f2fc85c571100e5821f1ac89f831.hlsl"
...
//
#line 57 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_1708061834_f3d8f2fc85c571100e5821f1ac89f831.hlsl"
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    float4 mul_3761043026 = mul(streams.Position_id14, World_id24);
    streams.PositionWS_id15 = mul_3761043026;
    float4 mul_3525510013 = mul(streams.Position_id14, WorldViewProjection_id29);
    streams.ShadingPosition_id0 = mul_3525510013;
    float4 join_4095101538 = float4(streams.meshNormal_id32, 0);
    float4 mul_3988410790 = mul(join_4095101538, WorldInverseTranspose_id26);
    float3 mulXyz_2855539191 = mul_3988410790.xyz;
    streams.normalWS_id35 = mulXyz_2855539191;
