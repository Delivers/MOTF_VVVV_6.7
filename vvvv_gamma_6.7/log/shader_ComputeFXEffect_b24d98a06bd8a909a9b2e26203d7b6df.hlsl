...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_382436180]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_382436180 => e6f0e517b1712974696290a2aa082665
...
// TextureInput_2836784736_id26      texture  float4          1d             t1      1 
// TextureInput_89956305_id28        texture  float4          1d             t2      1 
...
//
#line 168 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_b24d98a06bd8a909a9b2e26203d7b6df.hlsl"
...
#line 244
  mov r1.w, l(1.000000)
  dp4 r6.x, r1.xyzw, cb0[18].xyzw  // r6.x <- mul_2467525638.x

#line 246
  add r6.x, r6.x, l(0.500000)  // r6.x <- result_2927279148.x

#line 247
  sample_l_indexable(texture1d)(float,float,float,float) r7.xyzw, r6.x, t1.xyzw, s1, l(0.000000)  // r7.x <- textureNode_1240058305.x; r7.y <- textureNode_1240058305.y; r7.z <- textureNode_1240058305.z; r7.w <- textureNode_1240058305.w
...
#line 289
  dp4 r0.y, r1.xyzw, cb0[28].xyzw  // r0.y <- mul_491300783.x

#line 291
  add r0.y, r0.y, l(0.500000)  // r0.y <- result_2278098443.x

#line 292
  sample_l_indexable(texture1d)(float,float,float,float) r7.xyzw, r0.y, t2.xyzw, s2, l(0.000000)  // r7.x <- textureNode_3877813864.x; r7.y <- textureNode_3877813864.y; r7.z <- textureNode_3877813864.z; r7.w <- textureNode_3877813864.w
...
RWStructuredBuffer<Resource40272585> DynamicBufferInput_1282521623_id23;
Texture1D TextureInput_2597306058_id24;
SamplerState SamplerInput_1876793864_id25;
Texture1D TextureInput_2836784736_id26;
SamplerState SamplerInput_941011504_id27;
Texture1D TextureInput_89956305_id28;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource40272585 getBuffer_3372248743 = DynamicBufferInput_1282521623_id23[IndexX_3709646900];
