...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Fluid_AdvectDensity_Advanced_Internal_DrawFX
***************************
****  ConstantBuffers  ****
***************************
...
@C    vFlowDims_id95 => Fluid_AdvectDensity_Advanced_Internal_DrawFX.vFlowDims
@C    dissipation_id96 => Fluid_AdvectDensity_Advanced_Internal_DrawFX.dissipation
@C    timestep_id97 => Fluid_AdvectDensity_Advanced_Internal_DrawFX.timestep
***************************
******  Resources    ******
***************************
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    sampV_id98 => Fluid_AdvectDensity_Advanced_Internal_DrawFX.sampV [Stage: Pixel, Slot: (0-0)]
@R    sampT_id99 => Fluid_AdvectDensity_Advanced_Internal_DrawFX.sampT [Stage: Pixel, Slot: (1-1)]
...
*****     Sources     *****
***************************
@S    Fluid_AdvectDensity_Advanced_Internal_DrawFX => 38000e8a3bebd68bd5c35ba509a2f21b
...
//
#line 177 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_DrawFXEffect_eab87e15080074f66a4b580b23556e59.hlsl"
...
@G    Pixel => 8793188c498a5b42ee1397cef974ceab
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// Name                                 Type  Format         Dim      HLSL Bind  Count
// ------------------------------ ---------- ------- ----------- -------------- ------
// sampV_id98                        sampler      NA          NA             s0      1 
// sampT_id99                        sampler      NA          NA             s1      1 
...
//
#line 163 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_DrawFXEffect_eab87e15080074f66a4b580b23556e59.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xy, v1.xyxx, t0.xyzw, s0, l(0.000000)  // r0.x <- v.x; r0.y <- v.y
...
#line 165
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t1.xyzw, s1, l(0.000000)  // r0.x <- newValue.x; r0.y <- newValue.y; r0.z <- newValue.z; r0.w <- newValue.w
...
SamplerState sampV_id98 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Clamp;
    AddressV = Clamp;
};
SamplerState sampT_id99 : IMMUTABLE 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Clamp;
    AddressV = Clamp;
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    float4 v = Texture0_id37.SampleLevel(sampV_id98, pos, 0);
    pos += timestep_id97 * v.xy / vFlowDims_id95;
    float4 newValue = Texture1_id39.SampleLevel(sampT_id99, pos, 0);
