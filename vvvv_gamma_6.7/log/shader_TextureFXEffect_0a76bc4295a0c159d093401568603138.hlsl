...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Lomograph_Internal_TextureFX [{Color = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}, {Contrast = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Effect = InputFloat<ShaderFX.InputValueFloat.i6,PerUpdate>}, {Level = InputFloat<ShaderFX.InputValueFloat.i5,PerUpdate>}, {VignetteAmount = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {VignetteDodge = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {VignetteStart = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P VignetteStart: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P VignetteAmount: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P VignetteDodge: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
@P Color: InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>
@P Contrast: InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>
@P Level: InputFloat<ShaderFX.InputValueFloat.i5,PerUpdate>
@P Effect: InputFloat<ShaderFX.InputValueFloat.i6,PerUpdate>
...
@C    InputValue_id98 => ShaderFX.InputValueFloat.i3
@C    InputValue_id99 => ShaderFX.InputValueFloat.i4
@C    InputValue_id100 => ShaderFX.InputValueFloat.i6
...
@C    Type_id95 => Lomograph_Internal_TextureFX.Type
@C    Iterations_id96 => Lomograph_Internal_TextureFX.Iterations
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Lomograph_Internal_TextureFX => ff52c580644bde6f196b60eb24927234
...
//
#line 361 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_0a76bc4295a0c159d093401568603138.hlsl"
...
@G    Pixel => 0bfaec09396561ee6db4e368b98e50fd
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id101;            // Offset:   28 Size:     4
//   float InputValue_id102;            // Offset:   32 Size:     4
//   float InputValue_id103;            // Offset:   36 Size:     4
//   float InputValue_id104;            // Offset:   40 Size:     4
//
// }
//
// cbuffer PerView
...
//   int Type_id95;                     // Offset:   80 Size:     4
//      = 0x00000000 
//   int Iterations_id96;               // Offset:   84 Size:     4
//      = 0x00000004 
//
// }
//
...
//
#line 340 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_0a76bc4295a0c159d093401568603138.hlsl"
...
#line 289
imin r1.x, cb2[5].y, l(20)
itof r1.x, r1.x  // r1.x <- itr

#line 192
add r1.y, cb0[1].x, l(-0.500000)
...
#line 172
mad r1.w, -cb0[2].z, l(0.600000), r1.z
max r1.w, r1.w, l(0.000000)

#line 175
mad r2.xy, -cb0[2].zzzz, l(0.600000, 0.600000, 0.000000, 0.000000), l(1.000000, 1.340000, 0.000000, 0.000000)

#line 172
div r1.w, r1.w, r2.x  // r1.w <- Sglow

#line 173
mad r1.z, cb0[2].z, l(0.600000), -r1.z  // r1.z <- Dglow
...
#line 151
mul r2.y, cb0[1].w, l(2.000000)
mov_sat r2.y, r2.y

#line 152
mad_sat r2.z, cb0[1].w, l(2.000000), l(-1.000000)
...
#line 276
  ...
  mad r3.xy, cb0[1].zzzz, r1.xyxx, r3.xyxx  // r3.x <- x.x; r3.y <- x.y

#line 277
  max r1.x, r1.z, l(0.240000)
  add r1.x, -r3.z, r1.x
  mad r3.z, cb0[1].z, r1.x, r3.z  // r3.z <- x.z
...
#line 264
  mul r1.x, cb0[1].z, l(0.800000)  // r1.x <- eff
...
#line 221
  ...
  add r1.w, -r1.x, r1.w
  mad r3.y, cb0[1].z, r1.w, r1.x  // r3.y <- x.y
...
#line 222
  ...
  add r1.x, -r1.y, r1.x
  mad r3.x, cb0[1].z, r1.x, r1.y  // r3.x <- x.x
...
#line 223
  ...
  add r1.x, -r1.z, r1.x
  mad r3.z, cb0[1].z, r1.x, r1.z  // r3.z <- x.z
...
#line 204
  min r1.x, r1.z, r1.x
  add r1.x, -r3.x, r1.x
  mad r3.x, cb0[1].z, r1.x, r3.x  // r3.x <- x.x
...
#line 205
  ...
  min r1.x, r1.x, r1.y
  add r1.x, -r3.y, r1.x
  mad r3.y, cb0[1].z, r1.x, r3.y  // r3.y <- x.y

#line 206
  mul r1.x, cb0[1].z, l(0.100000)
  mad r1.y, r3.z, l(0.800000), r2.w
  add r1.y, r1.y, l(0.110000)
  add r1.y, -r3.z, r1.y
  mad r1.y, cb0[1].z, r1.y, r3.z
...
float4 prepass_id41(inout PS_STREAMS streams, float4 col)
{
    ...
    {
        z = ColorShape_id39(z, Compute_id44());
        z = Vignette_id37(z, length((x - 0.5) * R / R.x), Compute_id45(), Compute_id46(), Compute_id47());
        z = ColorContrast_id40(z, Compute_id48());
        z = ColorLevel_id38(z, Compute_id49());
    }
    col.rgb = z;
    return col;
}
...
float4 Filter_id42(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    {
        case 0:
            col.rgb = EffectShape1_id29(col.rgb, Compute_id50());
            break;
        case 1:
            col.rgb = EffectShape2_id30(col.rgb, Compute_id50());
            break;
        case 2:
            col.rgb = EffectShape3_id31(col.rgb, Compute_id50());
            break;
        case 3:
            col.rgb = EffectShape4_id32(col.rgb, Compute_id50());
            break;
        case 4:
            col.rgb = EffectShape5_id33(col.rgb, Compute_id50());
            break;
        case 5:
            col.rgb = EffectShapeE6C41_id35(col.rgb, Compute_id50());
            break;
        case 6:
            col.rgb = EffectShapeBW_id36(col.rgb, Compute_id50());
            break;
        case 7:
            col.rgb = EffectShapeSEPIA_id34(col.rgb, Compute_id50());
            break;
    }
    return col;
}
