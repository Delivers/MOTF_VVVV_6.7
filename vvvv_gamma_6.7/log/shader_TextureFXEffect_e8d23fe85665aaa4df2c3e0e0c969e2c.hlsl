...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Displace_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Offset = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {OffsetScale = InputFloat2<ShaderFX.InputValueFloat2.i1,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    Displace_Internal_TextureFX => e00712b0656f3ea188a273b76a35ed71
...
//
#line 186 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_e8d23fe85665aaa4df2c3e0e0c969e2c.hlsl"
...
@G    Pixel => 6efe883b19ba1af77ec4ba5e4d952cfc
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id92;            // Offset:   24 Size:     8
//
// }
//
//
...
//
#line 150 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_e8d23fe85665aaa4df2c3e0e0c969e2c.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xy, v1.xyxx, t1.xyzw, s2, l(0.000000)  // r0.x <- <InTex1_id27 return value>.x; r0.y <- <InTex1_id27 return value>.y
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float2 off = (offset.rg - Compute_id31()) * Compute_id32();
    float2 uv = streams.TexCoord_id62;
    return Texture0_id14.SampleLevel(LinearRepeatSampler_id50, uv + off.rg, 0);
}
