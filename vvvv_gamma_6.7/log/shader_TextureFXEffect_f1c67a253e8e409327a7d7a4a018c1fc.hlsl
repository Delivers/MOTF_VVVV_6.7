...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin GlowMixAddon_Internal_TextureFX [{AutoExposureFactor = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Exposure = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Exposure: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P AutoExposureFactor: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
*****     Sources     *****
***************************
@S    GlowMixAddon_Internal_TextureFX => 85978ec150ef6a3f8f94b21866eebc66
...
//
#line 197 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_f1c67a253e8e409327a7d7a4a018c1fc.hlsl"
...
@G    Pixel => 1c8ce3493e86895254a00519b6b00a30
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 176 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_f1c67a253e8e409327a7d7a4a018c1fc.hlsl"
...
mad r1.w, cb0[1].x, r1.w, l(1.000000)
div r1.w, cb0[1].y, r1.w
...
***************************
*************************/
static const float PW_id90 = 4.0f;
struct PS_STREAMS 
{
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    g /= 6.0;
    float4 c = s;
    float av = pow(max(0, Texture0_id14.SampleLevel(Sampler_id42, uv, 33).a), 1. / PW_id90);
    c = pow(max(0, s), 1 + g * 2) + g;
    c *= Compute_id31() / lerp(1, av + .1, Compute_id32());
    c.a = s.a;
    c.a = 1;
    return c;
}
