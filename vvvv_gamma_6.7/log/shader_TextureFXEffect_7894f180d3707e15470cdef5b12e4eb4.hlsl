...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Charcoal_Internal_TextureFX [{BackgroundColor = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {EdgeColor = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P BackgroundColor: InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>
@P EdgeColor: InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>
...
*****     Sources     *****
***************************
@S    Charcoal_Internal_TextureFX => 887006662d2715a5ccfb099b7d57015e
...
//
#line 201 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7894f180d3707e15470cdef5b12e4eb4.hlsl"
...
@G    Pixel => 32c9c3dbc600ce8f5f2948b2b5307aeb
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 162 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7894f180d3707e15470cdef5b12e4eb4.hlsl"
div r0.xy, cb0[3].xxxx, cb1[1].xyxx  // r0.x <- a; r0.y <- b
...
#line 164
sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyxx, t0.xyzw, s0, l(0.000000)  // r1.x <- c2.x; r1.y <- c2.y; r1.z <- c2.z

#line 165
sample_l_indexable(texture2d)(float,float,float,float) r0.xyz, r0.zwzz, t0.xyzw, s0, l(0.000000)  // r0.x <- c3.x; r0.y <- c3.y; r0.z <- c3.z

#line 163
sample_l_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.xyxx, t0.xyzw, s0, l(0.000000)  // r2.x <- c1.x; r2.y <- c1.y; r2.z <- c1.z; r2.w <- c1.w

#line 169
add r1.xyz, -r1.xyzx, r2.xyzx

#line 168
add r0.w, |r1.y|, |r1.x|  // r0.w <- f
...
#line 173
add_sat r0.x, r0.x, l(-0.200000)

#line 175
add r0.y, -r0.x, l(1.000000)
mul r0.xzw, r0.xxxx, cb0[2].xxyz
mad r2.xyz, cb0[1].xyzx, r0.yyyy, r0.xzwx
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float strength = Compute_id33();
    float a = strength / ViewSize_id77.x;
    float b = strength / ViewSize_id77.y;
    float4 c1 = Texture0_id14.SampleLevel(LinearSampler_id44, uv, 0);
    float4 c2 = Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(a, 0), 0);
    float4 c3 = Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(0, b), 0);
    float f = 0;
    f += abs(c1.x - c2.x);
    f += abs(c1.y - c2.y);
    f += abs(c1.z - c2.z);
    ...
    f -= 0.2;
    f = saturate(f);
    c1.rgb = Compute_id31().rgb * (1 - f) + Compute_id32().rgb * f;
    return c1;
}
