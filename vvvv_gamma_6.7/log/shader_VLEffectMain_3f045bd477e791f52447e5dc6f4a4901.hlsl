...
@C    InputValue_id206 => ShaderFX.InputValueFloat.i1
...
@R    EnvironmentLightingDFG_LUT_id218 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id218 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id218 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1219 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_VLEffectMain_3f045bd477e791f52447e5dc6f4a4901.hlsl"
...
//   float InputValue_id197;            // Offset:   16 Size:     4
//   float InputValue_id206;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id218    texture  float4          2d             t0      1 
...
//
#line 1286 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_VLEffectMain_3f045bd477e791f52447e5dc6f4a4901.hlsl"
...
#line 905
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id481 return value>.x; r7.y <- <ComputeDirectLightContribution_id481 return value>.y; r7.z <- <ComputeDirectLightContribution_id481 return value>.z
...
#line 662
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id297 return value>.x; r0.z <- <Compute_id297 return value>.y; r0.w <- <Compute_id297 return value>.z

#line 839
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id482 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id482 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id482 return value>.z
...
const static bool TInvert_id203 = true;
const static bool TIsEnergyConservative_id215 = false;
static const float PI_id217 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id218;
...
{
    streams.Input_1_id205 = Compute_id285();
}
...
float Compute_id279(inout PS_STREAMS streams)
{
...
float3 Compute_id297(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id218.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id451()
{
}
void AfterLightingAndShading_id431()
{
}
...
float3 ComputeEnvironmentLightContribution_id482(inout PS_STREAMS streams)
{
    ...
    return Compute_id297(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float3 ComputeDirectLightContribution_id481(inout PS_STREAMS streams)
{
    ...
    float normalDistribution = Compute_id392(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id217 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id448()
{
}
void PrepareForLightingAndShading_id428()
{
}
...
void Compute_id514(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id428();
    }

    {
        PrepareForLightingAndShading_id448();
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id217 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id431();
    }

    {
        AfterLightingAndShading_id451();
    }
}
void Compute_id497(inout PS_STREAMS streams)
{
    float metalness = Compute_id296(streams).r;
...
{
    float glossiness = Compute_id284(streams).r;
