...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin AddonBlurPass1_Internal_TextureFX [{Control = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_1> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_1>}]}, {Strength = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_0>}]}]
...
*****     Sources     *****
***************************
@S    AddonBlurPass1_Internal_TextureFX => af891583a26c0bebcd6f20a6b4bb6e33
...
//
#line 246 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_a68627a79c34ad58e596bb55f201eb17.hlsl"
...
@G    Pixel => 8c0b04c4d2d5abcab80243fe083b55bf
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 202 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_a68627a79c34ad58e596bb55f201eb17.hlsl"
...
{
    streams.Input_0_id101 = Compute_id84();
}
void Compute_id78(inout PS_STREAMS streams)
{
    streams.Default_1_id95 = Compute_id75();
}
float Lod_id29(float2 viewSize)
{
    return log2(max(viewSize.x, viewSize.y));
}
float Compute_id90(inout PS_STREAMS streams)
{
...
float Compute_id74(inout PS_STREAMS streams)
{
    Compute_id89(streams);
    return Compute_id90(streams);
}
...
float4 Filter_id71(inout PS_STREAMS streams, float4 tex0col)
{
    float lod;
    float2 off;
    float strength = Compute_id74(streams);
...
float4 Shading_id28(inout PS_STREAMS streams)
{
    ...
    return lerp(col, Filter_id71(streams, col), Compute_id73(streams));
}
