...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Rotate_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Rotate = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@C    Transform_id94 => Rotate_Internal_TextureFX.Transform
@C    InterpolationMode_id97 => Rotate_Internal_TextureFX.InterpolationMode
***************************
******  Resources    ******
***************************
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    Sampler0_id52 => Texturing.Sampler0 [Stage: Pixel, Slot: (0-0)]
@R    CustomSampler_id95 => Rotate_Internal_TextureFX.CustomSampler [Stage: Pixel, Slot: (1-1)]
...
*****     Sources     *****
***************************
@S    Rotate_Internal_TextureFX => faec359aa2a0a5f6da19a385d72f954c
...
//
#line 275 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_1bc77851baed89b588a47b9fb9157bae.hlsl"
...
@G    Pixel => e3f3483bb42500152da3348bee41eabc
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4x4 Transform_id94;           // Offset:   80 Size:    64 [unused]
//   uint InterpolationMode_id97;       // Offset:  144 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 254 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_1bc77851baed89b588a47b9fb9157bae.hlsl"
...
#line 239
mad r1.xy, v1.yxyy, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
#line 226
mul r1.zw, r1.xxxy, r2.xxxx

#line 225
mad r2.xz, r3.xxxx, r1.yyyy, r1.zzzz  // r2.z <- x

#line 226
mad r2.yw, r3.xxxx, r1.xxxx, -r1.wwww  // r2.w <- y

#line 239
mad r1.xyzw, r2.xyzw, l(1.000000, -1.000000, 1.000000, -1.000000), l(0.500000, 0.500000, 0.500000, 0.500000)  // r1.z <- uv.x; r1.w <- uv.y
...
{
    float2 uv = r2dCyc_id25((streams.TexCoord_id62 * 2 - 1) * float2(1, -1) * .5, Compute_id46()) * float2(1, -1) + 0.5;
    switch (InterpolationMode_id97)
