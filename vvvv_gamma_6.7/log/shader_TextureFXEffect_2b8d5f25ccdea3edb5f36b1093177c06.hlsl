...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Average_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    Type_id94 => Average_Internal_TextureFX.Type
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Average_Internal_TextureFX => 8a8bbabf05ed71f2fc198e289f025f31
...
//
#line 197 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_2b8d5f25ccdea3edb5f36b1093177c06.hlsl"
...
@G    Pixel => 0d684a101f0aa88a6222c11d56e8d0ef
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 176 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_2b8d5f25ccdea3edb5f36b1093177c06.hlsl"
...
#line 151
  sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t0.xyzw, s0  // r1.x <- c.x; r1.y <- c.y; r1.z <- c.z; r1.w <- c.w
...
#line 145
  sample_l_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t0.xyzw, s0, r2.x  // r1.x <- c.x; r1.y <- c.y; r1.z <- c.z; r1.w <- c.w
...
#line 171
  default 
  mov r1.xyzw, l(1.000000,1.000000,1.000000,1.000000)  // r1.x <- col.x; r1.y <- col.y; r1.z <- col.z; r1.w <- col.w
  break 
...
float4 AveragePass1_id70(inout PS_STREAMS streams)
{
    float4 c = Texture0_id14.SampleLevel(LinearSampler_id44, streams.TexCoord_id62, Lod_id29(ViewSize_id77));
    c.rgb /= c.a;
    return c;
}
float4 AveragePass0_id69(inout PS_STREAMS streams)
{
    float4 c = Texture0_id14.Sample(LinearSampler_id44, streams.TexCoord_id62);
    c.rgb *= c.a;
    return c;
}
float4 Compute_id72()
...
float4 Filter_id71(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    {
        case 0:
            col = AveragePass0_id69(streams);
            break;
        case 1:
            col = AveragePass1_id70(streams);
            break;
    }
    return col;
}
