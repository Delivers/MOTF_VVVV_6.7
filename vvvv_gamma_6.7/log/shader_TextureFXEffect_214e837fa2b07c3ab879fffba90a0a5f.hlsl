...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin ShiftRGB_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Direction = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Hue = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Shift = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}]
...
//
#line 227 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_214e837fa2b07c3ab879fffba90a0a5f.hlsl"
...
//
#line 152 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_214e837fa2b07c3ab879fffba90a0a5f.hlsl"
...
float4 ts_id29(Texture2D tex2d, float2 uv, float hue, float2 offset)
{
    float2 dir = sin((Compute_id32() + float2(0, .25)) * 2 * acos(-1));
    uv += dir * offset;
    float3 col = tex2d.SampleLevel(Sampler0_id52, uv, 0).rgb;
    return float4(HSVtoRGB_id9(float3(Compute_id33(), 0, 0) + RGBtoHSV_id12(col)), 1);
}
float Compute_id34()
{
...
float4 Filter_id30(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float shift = Compute_id34();
    float hue = Compute_id33();
    c.r = ts_id29(Texture0_id14, uv, hue, shift * .1).r;
    c.g = ts_id29(Texture0_id14, uv, hue, shift * 0).g;
    c.b = ts_id29(Texture0_id14, uv, hue, shift * -.1).b;
