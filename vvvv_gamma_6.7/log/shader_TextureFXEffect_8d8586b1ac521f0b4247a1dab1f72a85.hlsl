...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin LinearDepth_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {MaxDepth = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {MinDepth = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P MinDepth: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P MaxDepth: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
@C    Projection_id88 => LinearDepth_Internal_TextureFX.Projection
@C    Mapped_id91 => LinearDepth_Internal_TextureFX.Mapped
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    LinearDepth_Internal_TextureFX => 3c2c807f28a03856b9a164b09b61bb5e
...
//
#line 195 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_8d8586b1ac521f0b4247a1dab1f72a85.hlsl"
...
@G    Pixel => 967804aa35c73d4f73c97cbc5628184c
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Mapped_id91;                  // Offset:  144 Size:     4
//      = 0xffffffff 
//
// }
//
...
//
#line 161 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_8d8586b1ac521f0b4247a1dab1f72a85.hlsl"
...
movc r0.x, cb1[9].x, r0.y, r0.x  // r0.x <- c.x
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float4 c = Mapped_id91 ? saturate((ld - Compute_id31()) / (Compute_id32() - Compute_id31())) : ld;
    return c;
}
