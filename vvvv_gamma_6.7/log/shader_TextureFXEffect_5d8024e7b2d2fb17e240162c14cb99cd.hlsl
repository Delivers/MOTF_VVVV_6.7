...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Voronoi_Inside_Internal_TextureFX [{ColorA = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {ColorB = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Inside = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {InsideFade = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Size = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {Time = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Time: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P InsideFade: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P Inside: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
...
*****     Sources     *****
***************************
@S    Voronoi_Inside_Internal_TextureFX => 31458f73c9579950949164925310e4a1
...
//
#line 234 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_5d8024e7b2d2fb17e240162c14cb99cd.hlsl"
...
@G    Pixel => 5b76c801e4cc5e1d87467caa284a55d4
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 215 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_5d8024e7b2d2fb17e240162c14cb99cd.hlsl"
div r0.xy, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[2].zwzz
...
#line 217
mul r0.x, cb0[2].y, l(32.000000)
mul r0.y, r2.x, cb0[2].x
sincos r0.y, null, r0.y
mul r0.x, r0.y, r0.x
mad r0.x, -r2.x, r0.x, l(1.000000)  // r0.x <- col.x
...
float4 Shading_id70(inout PS_STREAMS streams)
{
    ...
    col = lerp(float4(1.0, 1.0, 1.0, 1.0), col, c.x * ((Compute_id72() * 32) * sin(Compute_id73() * c.x)));
