...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Translate_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Translate = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]
@P Translate: InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>
...
@C    InterpolationMode_id96 => Translate_Internal_TextureFX.InterpolationMode
***************************
******  Resources    ******
***************************
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    Sampler0_id52 => Texturing.Sampler0 [Stage: Pixel, Slot: (0-0)]
@R    CustomSampler_id94 => Translate_Internal_TextureFX.CustomSampler [Stage: Pixel, Slot: (1-1)]
...
*****     Sources     *****
***************************
@S    Translate_Internal_TextureFX => 2a6f0246475fc0d8599124d1866ae9dc
...
//
#line 266 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_75375b801ea78136212e6e80c0b72828.hlsl"
...
@G    Pixel => be5b32dad3f50ceacb1db1f0ac019ed7
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   uint InterpolationMode_id96;       // Offset:   80 Size:     4
//      = 0x00000000 
//
// }
//
...
// CustomSampler_id94                sampler      NA          NA             s1      1 
...
//
#line 245 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_75375b801ea78136212e6e80c0b72828.hlsl"
...
#line 230
add r1.xyzw, v1.xyxy, cb0[1].xyxy  // r1.z <- uv.x; r1.w <- uv.y
...
SamplerState CustomSampler_id94;
...
{
    float2 uv = streams.TexCoord_id62 + Compute_id46();
    switch (InterpolationMode_id96)

    {
        case 0:
            return Texture0_id14.Sample(CustomSampler_id94, uv);
        case 1:
            return SampleCubicBSpline_id31(Texture0_id14, CustomSampler_id94, uv);
        case 2:
            return SampleCubicCatmullRom_id36(Texture0_id14, CustomSampler_id94, uv);
    }
    return 1;
}
