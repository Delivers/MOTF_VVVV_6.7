...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_Dot_Internal_TextureFX [{BackgroundColor = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {HatchColor = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@C    Density_id91 => Hatch_Dot_Internal_TextureFX.Density
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Hatch_Dot_Internal_TextureFX => 584e9b5eb41de3771ab94bdd61190140
...
//
#line 189 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_99f502a39453d0b27e3c61618b41d6f3.hlsl"
...
@G    Pixel => d40be94e62005d01c98eb1e56240ba55
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 161 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_99f502a39453d0b27e3c61618b41d6f3.hlsl"
...
mad r0.xyzw, r0.xyzw, r2.xyzw, cb0[2].xyzw  // r0.x <- <Filter_id29 return value>.x; r0.y <- <Filter_id29 return value>.y; r0.z <- <Filter_id29 return value>.z; r0.w <- <Filter_id29 return value>.w
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    return lerp(Compute_id31(), Compute_id32(), any(((x.x * 5.0 + x.y) % Density_id91 < col.b * Compute_id33())) * float4(1, 1, 1, col.a));
}
