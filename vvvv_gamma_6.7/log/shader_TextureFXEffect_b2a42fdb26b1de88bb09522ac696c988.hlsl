...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Keying_Channel_Internal_TextureFX [{AlphaBlur = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Smooth = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Threshold: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Smooth: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P AlphaBlur: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
...
@C    Type_id88 => Keying_Channel_Internal_TextureFX.Type
@C    Invert_id92 => Keying_Channel_Internal_TextureFX.Invert
@C    SourceAlpha_id93 => Keying_Channel_Internal_TextureFX.SourceAlpha
@C    Premultiply_id94 => Keying_Channel_Internal_TextureFX.Premultiply
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Keying_Channel_Internal_TextureFX => 1c70f219158d1e8be4559a4ed1baa274
...
//
#line 269 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_b2a42fdb26b1de88bb09522ac696c988.hlsl"
...
@G    Pixel => 25057fc976e660f670ab8c5cd526330b
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Invert_id92;                  // Offset:   84 Size:     4
//      = 0x00000000 
//   bool SourceAlpha_id93;             // Offset:   88 Size:     4
//      = 0x00000000 
//   bool Premultiply_id94;             // Offset:   92 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 248 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_b2a42fdb26b1de88bb09522ac696c988.hlsl"
...
#line 166
  add r3.x, -cb0[1].y, cb0[1].z
  add r3.y, cb0[1].y, cb0[1].z
...
#line 174
  movc r2.xyz, cb2[5].wwww, r3.yzwy, r0.xyzx  // r2.x <- col.x; r2.y <- col.y; r2.z <- col.z

#line 177
  mul r3.y, r1.w, r3.x  // r3.y <- col.w

#line 178
  movc r2.w, cb2[5].z, r3.y, r3.x  // r2.w <- col.w
...
#line 166
  add r1.y, -cb0[1].y, cb0[1].z
  add r1.z, cb0[1].y, cb0[1].z
...
#line 174
  movc r2.xyz, cb2[5].wwww, r3.xyzx, r0.xyzx  // r2.x <- col.x; r2.y <- col.y; r2.z <- col.z

#line 177
  mul r1.y, r1.w, r1.x  // r1.y <- col.w

#line 178
  movc r2.w, cb2[5].z, r1.y, r1.x  // r2.w <- col.w
...
{
    float threshold = Compute_id40();
    float smooth = Compute_id41();
...
{
    return Texture0_id14.SampleLevel(Sampler0_id52, uv, (saturate(Compute_id39()) * log2(max(R.x, R.y))));
}
float4 Compute_id38()
{
