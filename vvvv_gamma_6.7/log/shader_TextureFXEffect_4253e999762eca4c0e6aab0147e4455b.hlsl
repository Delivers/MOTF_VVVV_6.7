...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurDirectional_Pass1_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Direction = InputFloat2<ShaderFX.InputValueFloat2.i1,PerUpdate>}, {SampleCenter = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Strength: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P SampleCenter: InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>
@P Direction: InputFloat2<ShaderFX.InputValueFloat2.i1,PerUpdate>
...
@C    Aspect_id91 => BlurDirectionalBase.Aspect
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    BlurDirectional_Pass1_Internal_TextureFX => badd750271a22d17bb127db8a3bc141d
@S    BlurDirectionalBase => 867e9183b2608cf2427032246d40a44e
...
//
#line 195 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_4253e999762eca4c0e6aab0147e4455b.hlsl"
...
@G    Pixel => ea55100a2dd8ad4f96e703b692d5e573
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id95;             // Offset:   32 Size:     4
//
// }
//
// cbuffer PerView
...
//   bool Aspect_id91;                  // Offset:   80 Size:     4
//      = 0xffffffff 
//
// }
//
...
//
#line 174 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_4253e999762eca4c0e6aab0147e4455b.hlsl"
...
#line 167
  mad r4.xy, -cb0[1].zwzz, l(0.500000, 0.500000, 0.000000, 0.000000), r2.wwww
...
{
    float2 asp = lerp(1, ViewSize_id77.x / ViewSize_id77, Aspect_id91);
    int iter = 16;
    float ctrl = Compute_id32();
    float4 col = 0;

    for (float i = 0; i < 1; i += 1.0 / iter)
    {
        col += Texture0_id14.SampleLevel(Sampler0_id52, ((streams.TexCoord_id62 - 0.5) / asp + Compute_id33() * float2(1, -1) * ctrl * (i - 0.5 - Compute_id34() * 0.5)) * asp + 0.5, 0);
    }
    col = col / iter;
    return col;
}
