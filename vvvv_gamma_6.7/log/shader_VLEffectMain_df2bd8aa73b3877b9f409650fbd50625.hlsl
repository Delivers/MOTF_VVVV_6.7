...
@C    constantColor_id196 => Material.DiffuseValue
@C    InputValue_id199 => ShaderFX.InputValueFloat
@C    InputValue_id208 => ShaderFX.InputValueFloat.i1
...
//
#line 1189 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_VLEffectMain_df2bd8aa73b3877b9f409650fbd50625.hlsl"
...
@G    Pixel => 5023c61dcd0a2b57b84a0858e967d7a7
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 constantColor_id196;        // Offset:    0 Size:    16
//   float InputValue_id199;            // Offset:   16 Size:     4
//   float InputValue_id208;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 1298 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_VLEffectMain_df2bd8aa73b3877b9f409650fbd50625.hlsl"
...
#line 466
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.z, r12.xyxx, t1.xxxx, s1, r8.z  // r9.z <- <SampleTextureAndCompare_id71 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.w, r12.zwzz, t1.xxxx, s1, r8.z  // r9.w <- <SampleTextureAndCompare_id71 return value>
...
#line 466
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id71 return value>
...
#line 466
      sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r12.xyxx, t1.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id71 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r12.zwzz, t1.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id71 return value>
...
#line 466
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.xyxx, t1.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id71 return value>
...
#line 913
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id485 return value>.x; r7.y <- <ComputeDirectLightContribution_id485 return value>.y; r7.z <- <ComputeDirectLightContribution_id485 return value>.z
...
#line 900
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id227 return value>
...
#line 878
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id239 return value>
...
#line 670
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id301 return value>.x; r0.z <- <Compute_id301 return value>.y; r0.w <- <Compute_id301 return value>.z

#line 847
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id486 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id486 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id486 return value>.z
...
#line 655
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t6.xyzw, s0, r0.x  // r1.x <- <Compute_id261 return value>.x; r1.y <- <Compute_id261 return value>.y; r1.z <- <Compute_id261 return value>.z
...
cbuffer PerMaterial 
{
    float4 constantColor_id196;
    float InputValue_id199;
...
{
    streams.Input_1_id207 = Compute_id289();
}
void Compute_id280(inout PS_STREAMS streams)
{
    streams.Input_0_id198 = Compute_id277();
}
...
float3 Compute_id301(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id220.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
float3 Compute_id334(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id455()
{
}
...
void PrepareEnvironmentLight_id271(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id49 = Compute_id256(sampleDirection).rgb * Intensity_id193 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id50 = Compute_id261(streams, sampleDirection).rgb * Intensity_id193 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
float3 ComputeEnvironmentLightContribution_id486(inout PS_STREAMS streams)
{
    ...
    return Compute_id301(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id334(streams, specularColor);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id219 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id452()
{
}
...
{
    float x = Compute_id286(streams);
    return float4(x, x, x, x);
}
float4 Compute_id275()
{
    return constantColor_id196;
}
...
void Compute_id518(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id452();
    }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id219 + environmentLightingContribution;
    ...
    {
        AfterLightingAndShading_id455();
    }
}
void Compute_id501(inout PS_STREAMS streams)
{
    float metalness = Compute_id300(streams).r;
...
{
    float glossiness = Compute_id288(streams).r;
...
{
    float4 colorBase = Compute_id275();
