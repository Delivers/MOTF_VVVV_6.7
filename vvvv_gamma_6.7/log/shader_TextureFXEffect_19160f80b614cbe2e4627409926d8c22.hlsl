...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Dilate_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {MaxThreshold = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {MinThreshold = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Separation = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Separation: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P MinThreshold: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P MaxThreshold: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
...
@C    Size_id88 => Dilate_Internal_TextureFX.Size
@C    Shape_id92 => Dilate_Internal_TextureFX.Shape
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Dilate_Internal_TextureFX => 88fb811c512bbfad37cdcc465a58fb32
...
//
#line 229 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_19160f80b614cbe2e4627409926d8c22.hlsl"
...
@G    Pixel => ecbe7c12482ead32da17c5aa0fbb5901
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x00000001 
//   int Shape_id92;                    // Offset:   84 Size:     4
//
// }
//
//
...
//
#line 208 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_19160f80b614cbe2e4627409926d8c22.hlsl"
...
#line 168
  ...
  mov r1.z, l(0)  // r1.z <- mx
  mov r1.w, r1.x  // r1.w <- i
  loop 
    ilt r2.w, cb2[5].x, r1.w
    breakc_nz r2.w
...
#line 171
    mov r4.yzw, r2.xxyz  // r4.y <- cmx.x; r4.z <- cmx.y; r4.w <- cmx.z
    mov r4.x, r1.z  // r4.x <- mx
    mov r5.x, r1.x  // r5.x <- j
    loop 
      ilt r5.y, cb2[5].x, r5.x
      breakc_nz r5.y
...
#line 180
        imax r5.z, -r5.x, r5.x
        iadd r5.z, -r5.z, cb2[5].x
        ilt r5.y, r5.z, r2.w  // r5.y <- skip
...
#line 194
        itof r3.y, r5.x
        mul r3.yw, r3.xxxy, cb0[1].zzzz
        div r3.yw, r3.yyyw, cb1[1].xxxy
        add r3.yw, r3.yyyw, v1.xxxy
        sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r3.ywyy, t0.wxyz, s0, l(0.000000)  // r6.y <- c.x; r6.z <- c.y; r6.w <- c.z
...
#line 200
        movc r4.xyzw, r3.yyyy, r6.xyzw, r4.xyzw
...
#line 202
      iadd r5.x, r5.x, l(1)
    endloop 
    mov r2.xyz, r4.yzwy  // r2.x <- cmx.x; r2.y <- cmx.y; r2.z <- cmx.z
    mov r1.z, r4.x  // r1.z <- mx
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    for (int i = -Size_id88; i <= Size_id88; ++i)
    {
        ...
        for (int j = -Size_id88; j <= Size_id88; ++j)
        {
            ...
            if (!skip)
            {
                float4 c = Texture0_id14.SampleLevel(Sampler0_id52, streams.TexCoord_id62 + float2(i, j) * Compute_id31() / ViewSize_id77, 0);
    ...
    return float4(lerp(tex0col.rgb, cmx.rgb, smoothstep(Compute_id32(), Compute_id33(), mx)), tex0col.a);
}
