...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_1496308806]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_1496308806 => f711d9640004f0fe891bbab38ef0c5ef
...
// TextureInput_3601353252_id27      texture  float4          1d             t1      1 
// TextureInput_2118481169_id29      texture  float4          1d             t2      1 
// TextureInput_3959990167_id31      texture  float4          1d             t3      1 
...
//
#line 178 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_abc034fc718c46805a1705d4e0ee892a.hlsl"
...
#line 260
  mov r1.w, l(1.000000)
  dp4 r0.w, r1.xyzw, cb0[21].xyzw  // r0.w <- mul_2703289878.x

#line 262
  add r0.w, r0.w, l(0.500000)  // r0.w <- result_1116403132.x

#line 263
  sample_l_indexable(texture1d)(float,float,float,float) r6.xyzw, r0.w, t1.xyzw, s2, l(0.000000)  // r6.x <- textureNode_163187453.x; r6.y <- textureNode_163187453.y; r6.z <- textureNode_163187453.z; r6.w <- textureNode_163187453.w
...
#line 269
  dp4 r6.y, r1.xyzw, cb0[27].xyzw  // r6.y <- mul_1533991091.x

#line 271
  add r6.y, r6.y, l(0.500000)  // r6.y <- result_3006956111.x

#line 272
  sample_l_indexable(texture1d)(float,float,float,float) r7.xyzw, r6.y, t2.xyzw, s3, l(0.000000)  // r7.x <- textureNode_2855179728.x; r7.y <- textureNode_2855179728.y; r7.z <- textureNode_2855179728.z; r7.w <- textureNode_2855179728.w
...
#line 277
  dp4 r1.w, r1.xyzw, cb0[33].xyzw  // r1.w <- mul_3402475513.x

#line 279
  add r1.w, r1.w, l(0.500000)  // r1.w <- result_4081769685.x

#line 280
  sample_l_indexable(texture1d)(float,float,float,float) r7.xyzw, r1.w, t3.xyzw, s4, l(0.000000)  // r7.x <- textureNode_4158959786.x; r7.y <- textureNode_4158959786.y; r7.z <- textureNode_4158959786.z; r7.w <- textureNode_4158959786.w
...
RWStructuredBuffer<Resource35633034> DynamicBufferInput_4252052980_id23;
...
Texture1D TextureInput_3601353252_id27;
SamplerState SamplerInput_494671780_id28;
Texture1D TextureInput_2118481169_id29;
SamplerState SamplerInput_1323902017_id30;
Texture1D TextureInput_3959990167_id31;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource35633034 getBuffer_3291917120 = DynamicBufferInput_4252052980_id23[IndexX_2632966837];
