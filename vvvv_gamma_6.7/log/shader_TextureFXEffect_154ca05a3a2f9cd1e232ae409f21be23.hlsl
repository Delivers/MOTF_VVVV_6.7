...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin ThresholdDiscard_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Discard = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Discard: InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>
...
*****     Sources     *****
***************************
@S    ThresholdDiscard_Internal_TextureFX => affb4359b87b4710ea046da4e567affe
...
//
#line 179 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_154ca05a3a2f9cd1e232ae409f21be23.hlsl"
...
@G    Pixel => 0672e9d8a45a9cea220d794e5e95bc56
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 153 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_154ca05a3a2f9cd1e232ae409f21be23.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, v1.xyxx, t1.xyzw, s0, l(0.000000)  // r0.x <- c.x; r0.y <- c.y; r0.z <- c.z; r0.w <- c.w
...
sqrt r2.x, r2.x
lt r2.x, r2.x, cb0[1].x
movc r0.xyzw, r2.xxxx, r1.xyzw, r0.xyzw  // r0.x <- <Filter_id29 return value>.x; r0.y <- <Filter_id29 return value>.y; r0.z <- <Filter_id29 return value>.z; r0.w <- <Filter_id29 return value>.w
...
{
    float4 c = Texture1_id16.SampleLevel(LinearSampler_id44, streams.TexCoord_id62, 0);
    return length(tex0col - Compute_id31()) < Compute_id32() ? tex0col : c;
}
