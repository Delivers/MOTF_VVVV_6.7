...
***** Compiler Parameters *****
***************************
@P EffectName: Shader_1017083594
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Shader_1017083594 => 34549e4a94edca37df3f1719bb6dc17f
...
//
#line 66 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_1017083594_4fca0ed35edc8083fac6c00368223f62.hlsl"
...
//
#line 57 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_1017083594_4fca0ed35edc8083fac6c00368223f62.hlsl"
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    float4 mul_1162664685 = mul(streams.Position_id14, World_id24);
    streams.PositionWS_id15 = mul_1162664685;
    float4 mul_1608651528 = mul(streams.Position_id14, WorldViewProjection_id29);
    streams.ShadingPosition_id0 = mul_1608651528;
    float4 join_948657403 = float4(streams.meshNormal_id32, 0);
    float4 mul_3429431023 = mul(join_948657403, WorldInverseTranspose_id26);
    float3 mulXyz_2907669678 = mul_3429431023.xyz;
    streams.normalWS_id35 = mulXyz_2907669678;
