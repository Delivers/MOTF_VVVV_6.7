...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Dots_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {PixelSize = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}, {Scale = InputFloat2<ShaderFX.InputValueFloat2.i1,PerUpdate>}, {Smooth = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P PixelSize: InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>
...
*****     Sources     *****
***************************
@S    Dots_TextureFX => 94ea4cd59f345768df4c164dd68eace8
...
//
#line 209 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_54c03b80abb6aa933e3ee7381b7986a2.hlsl"
...
@G    Pixel => e5fb0985e968abf92842ed9f9b7b5b5f
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Alpha_id89;                   // Offset:   80 Size:     4
//      = 0x00000000 
//   bool Point_id90;                   // Offset:   84 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 169 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_54c03b80abb6aa933e3ee7381b7986a2.hlsl"
...
max r1.xy, r0.zwzz, cb0[1].xyxx
min r1.xy, r1.xyxx, cb1[1].xyxx  // r1.x <- sz.x; r1.y <- sz.y
...
div r1.xy, r1.xyxx, cb0[1].zwzz
dp2 r1.x, r1.xyxx, r1.xyxx
sqrt r1.x, r1.x  // r1.x <- glow

#line 178
deriv_rtx_coarse r1.y, r1.x
deriv_rty_coarse r1.z, r1.x
add r1.y, |r1.z|, |r1.y|
mul_sat r1.z, cb0[1].x, l(0.500000)
mad r1.y, -r1.y, r1.z, l(1.000000)
add_sat r1.z, -cb0[2].x, l(1.000000)
mul r1.z, r1.z, l(0.470000)
mad r1.y, r1.z, r1.y, l(-0.480000)
...
#line 177
movc r1.z, cb2[5].y, l(1.000000), r1.z  // r1.z <- grey
...
#line 183
movc r2.w, cb2[5].x, r0.x, r0.w  // r2.w <- col.w
...
float4 Filter_id30(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float2 pixelSize = Compute_id33();
    float smooth = Compute_id34();
    float2 vp = uv * ViewSize_id77 - .25;
    float2 sz = min(max(0.5 / ViewSize_id77, pixelSize), ViewSize_id77);
    float4 col = Texture0_id14.SampleLevel(Sampler0_id52, floor(vp / sz) * sz / ViewSize_id77 + 0.5 / ViewSize_id77, 0);
