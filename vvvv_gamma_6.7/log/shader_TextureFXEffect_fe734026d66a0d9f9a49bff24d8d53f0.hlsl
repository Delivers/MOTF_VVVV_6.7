...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_Line_Internal_TextureFX [{BackgroundColor = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {HatchColor = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Rotation = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Thickness = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@C    InputValue_id94 => ShaderFX.InputValueFloat4_Color
@C    InputValue_id95 => ShaderFX.InputValueFloat4_Color.i1
...
*****     Sources     *****
***************************
@S    Hatch_Line_Internal_TextureFX => e13dc0dd00cbd5ae0f814691b5849627
...
//
#line 206 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fe734026d66a0d9f9a49bff24d8d53f0.hlsl"
...
@G    Pixel => 3c9b1034822da88d0fac3bb028bbfee6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id95;            // Offset:   32 Size:    16
//   float InputValue_id96;             // Offset:   48 Size:     4
//   float InputValue_id97;             // Offset:   52 Size:     4
//   float InputValue_id98;             // Offset:   56 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 178 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fe734026d66a0d9f9a49bff24d8d53f0.hlsl"
...
#line 145
mul r0.z, cb0[3].x, l(6.283185)  // r0.z <- a
...
mul r0.y, r0.x, cb0[3].y
ge r0.y, r0.y, -r0.y
movc r0.y, r0.y, cb0[3].y, -cb0[3].y
...
float4 Filter_id30(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float thickNess = Compute_id35();
    float rotation = Compute_id36();
    float2 uv = streams.TexCoord_id62;
    float2 x = uv * ViewSize_id77 - 0.5;
    float4 col = Texture0_id14.SampleLevel(Sampler0_id52, uv, 0);
    col.rgb = sqrt(col.rgb);
    return lerp(Compute_id32(), Compute_id33(), any(((r2d_id29(x - ViewSize_id77 * .5, rotation) + ViewSize_id77).y) % thickNess < col.rgb * threshold)) * float4(1, 1, 1, col.a);
}
