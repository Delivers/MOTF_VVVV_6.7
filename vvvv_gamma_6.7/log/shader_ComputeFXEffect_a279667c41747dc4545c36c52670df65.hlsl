...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_696329273]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_696329273 => 9b07f5b72da6fff9836a08686b9be9ea
...
*****     Stages      *****
***************************
@G    Compute => 6229bcfbc821047448d572d217d073f2
//
...
// TextureInput_2541052044_id24      texture  float4          3d             t0      1 
// TextureInput_1840561177_id27      texture  float4          3d             t1      1 
// TextureInput_2704499526_id29      texture  float4          3d             t2      1 
// TextureInput_1416492620_id31      texture  float4          3d             t3      1 
...
//
#line 178 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_a279667c41747dc4545c36c52670df65.hlsl"
...
#line 197
  mov r1.w, l(1.000000)
  dp4 r2.x, r1.xyzw, cb0[2].xyzw  // r2.x <- mul_561827957.x
  dp4 r2.y, r1.xyzw, cb0[3].xyzw  // r2.y <- mul_561827957.y
  dp4 r2.z, r1.xyzw, cb0[4].xyzw  // r2.z <- mul_561827957.z

#line 199
  add r2.xyz, r2.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r2.x <- result_1034972569.x; r2.y <- result_1034972569.y; r2.z <- result_1034972569.z

#line 200
  sample_l_indexable(texture3d)(float,float,float,float) r2.xyz, r2.xyzx, t0.xyzw, s0, l(0.000000)  // r2.x <- textureNode_3461074432.x; r2.y <- textureNode_3461074432.y; r2.z <- textureNode_3461074432.z
...
#line 230
  mov r3.w, l(1.000000)
  dp4 r4.x, r3.xyzw, cb0[12].xyzw  // r4.x <- mul_2_561827957.x
  dp4 r4.y, r3.xyzw, cb0[13].xyzw  // r4.y <- mul_2_561827957.y
  dp4 r4.z, r3.xyzw, cb0[14].xyzw  // r4.z <- mul_2_561827957.z

#line 232
  add r3.xyz, r4.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r3.x <- result_2_1034972569.x; r3.y <- result_2_1034972569.y; r3.z <- result_2_1034972569.z

#line 233
  sample_l_indexable(texture3d)(float,float,float,float) r3.xyz, r3.xyzx, t0.xyzw, s1, l(0.000000)  // r3.x <- textureNode_2_3461074432.x; r3.y <- textureNode_2_3461074432.y; r3.z <- textureNode_2_3461074432.z
...
#line 260
  mov r1.w, l(1.000000)
  dp4 r6.x, r1.xyzw, cb0[21].xyzw  // r6.x <- mul_3607894323.x
  dp4 r6.y, r1.xyzw, cb0[22].xyzw  // r6.y <- mul_3607894323.y
  dp4 r6.z, r1.xyzw, cb0[23].xyzw  // r6.z <- mul_3607894323.z

#line 262
  add r6.xyz, r6.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r6.x <- result_1723904087.x; r6.y <- result_1723904087.y; r6.z <- result_1723904087.z

#line 263
  sample_l_indexable(texture3d)(float,float,float,float) r6.xyzw, r6.xyzx, t1.xyzw, s2, l(0.000000)  // r6.x <- textureNode_4186874210.x; r6.y <- textureNode_4186874210.y; r6.z <- textureNode_4186874210.z; r6.w <- textureNode_4186874210.w
...
#line 269
  dp4 r7.x, r1.xyzw, cb0[27].xyzw  // r7.x <- mul_3283051280.x
  dp4 r7.y, r1.xyzw, cb0[28].xyzw  // r7.y <- mul_3283051280.y
  dp4 r7.z, r1.xyzw, cb0[29].xyzw  // r7.z <- mul_3283051280.z

#line 271
  add r6.yzw, r7.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)  // r6.y <- result_2113846826.x; r6.z <- result_2113846826.y; r6.w <- result_2113846826.z

#line 272
  sample_l_indexable(texture3d)(float,float,float,float) r7.xyzw, r6.yzwy, t2.xyzw, s3, l(0.000000)  // r7.x <- textureNode_926184821.x; r7.y <- textureNode_926184821.y; r7.z <- textureNode_926184821.z; r7.w <- textureNode_926184821.w
...
#line 277
  dp4 r7.x, r1.xyzw, cb0[33].xyzw  // r7.x <- mul_3043853526.x
  dp4 r7.y, r1.xyzw, cb0[34].xyzw  // r7.y <- mul_3043853526.y
  dp4 r7.z, r1.xyzw, cb0[35].xyzw  // r7.z <- mul_3043853526.z

#line 279
  add r7.xyz, r7.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r7.x <- result_46306096.x; r7.y <- result_46306096.y; r7.z <- result_46306096.z

#line 280
  sample_l_indexable(texture3d)(float,float,float,float) r7.xyzw, r7.xyzx, t3.xyzw, s4, l(0.000000)  // r7.x <- textureNode_3546130895.x; r7.y <- textureNode_3546130895.y; r7.z <- textureNode_3546130895.z; r7.w <- textureNode_3546130895.w
...
RWStructuredBuffer<Resource35620248> DynamicBufferInput_1430151697_id23;
Texture3D<float4> TextureInput_2541052044_id24;
SamplerState SamplerInput_3596066227_id25;
SamplerState SamplerInput_2_3596066227_id26;
Texture3D<float4> TextureInput_1840561177_id27;
SamplerState SamplerInput_1973253577_id28;
Texture3D<float4> TextureInput_2704499526_id29;
SamplerState SamplerInput_1889927718_id30;
Texture3D<float4> TextureInput_1416492620_id31;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource35620248 getBuffer_608833529 = DynamicBufferInput_1430151697_id23[IndexX_2325186706];
