...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Scale_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Scale = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]
...
@C    Transform_id94 => Scale_Internal_TextureFX.Transform
@C    InterpolationMode_id97 => Scale_Internal_TextureFX.InterpolationMode
***************************
******  Resources    ******
***************************
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    Sampler0_id52 => Texturing.Sampler0 [Stage: Pixel, Slot: (0-0)]
@R    CustomSampler_id95 => Scale_Internal_TextureFX.CustomSampler [Stage: Pixel, Slot: (1-1)]
...
*****     Sources     *****
***************************
@S    Scale_Internal_TextureFX => 24e24d9c00df7034d8f5d95424b8cb72
...
//
#line 267 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_6d77ed16469694e49bdcce8cd9e15e36.hlsl"
...
@G    Pixel => 01db4559b94749b96fbde18eaffc599a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 246 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_6d77ed16469694e49bdcce8cd9e15e36.hlsl"
...
mad r1.xyzw, r1.xyzw, cb0[1].xyxy, l(0.500000, 0.500000, 0.500000, 0.500000)  // r1.z <- uv.x; r1.w <- uv.y
...
{
    float2 uv = (streams.TexCoord_id62 - 0.5) * Compute_id46() + 0.5;
