...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Colorize_Internal_TextureFX [{ColorA = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {ColorB = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {ColorC = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
...
@C    InputValue_id94 => ShaderFX.InputValueFloat4_Color.i2
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Colorize_Internal_TextureFX => 145ffb00ffa318748f97130bc90dadc9
...
//
#line 204 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_beece25e226080ce1628bebe3c8c95f0.hlsl"
...
@G    Pixel => 0652d9e8dbda7062c5d80332241b265b
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id94;            // Offset:   48 Size:    16
//
// }
//
//
...
//
#line 165 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_beece25e226080ce1628bebe3c8c95f0.hlsl"
mov x0[0].xyz, cb0[1].xyzx

#line 166
mov x0[1].xyz, cb0[2].xyzx

#line 167
mov x0[2].xyz, cb0[3].xyzx

#line 159
sample_l_indexable(texture2d)(float,float,float,float) r0.xyz, v1.xyxx, t0.xyzw, s0, l(0.000000)
dp3 r0.x, r0.xyzx, r0.xyzx
sqrt r0.x, r0.x  // r0.x <- pixcol.x

#line 168
dp3 r0.x, r0.xxxx, l(0.330000, 0.330000, 0.330000, 0.000000)  // r0.x <- lum

#line 170
lt r0.y, r0.x, l(0.500000)

#line 178
movc r0.yzw, r0.yyyy, l(0,0,1,-0.000000), l(0,1,2,-0.500000)
mov r1.xyz, x0[r0.z + 0].xyzx
mov r2.xyz, x0[r0.y + 0].xyzx
add r0.x, r0.w, r0.x
add r0.x, r0.x, r0.x
add r0.yzw, r1.xxyz, -r2.xxyz
mad r0.xyz, r0.xxxx, r0.yzwy, r2.xyzx  // r0.x <- tc.x; r0.y <- tc.y; r0.z <- tc.z
...
{
    float3 pixcol = length(Texture0_id14.SampleLevel(LinearRepeatSampler_id50, streams.TexCoord_id62, 0).rgb);
    float3 tc = float3(1.0, 0.0, 0.0);
    float4 colorA = Compute_id32();
    float4 colorB = Compute_id33();
    float4 colorC = Compute_id34();
    float3 colors[3];
