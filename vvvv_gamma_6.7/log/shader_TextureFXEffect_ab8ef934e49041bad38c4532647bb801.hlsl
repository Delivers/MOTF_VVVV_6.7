...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurMips_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    BlurMips_Internal_TextureFX => 0a3db6b625d374da92518c62aaaa01a9
...
//
#line 178 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ab8ef934e49041bad38c4532647bb801.hlsl"
...
@G    Pixel => 05237959edab80e5a3c238428611c5d3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 145 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ab8ef934e49041bad38c4532647bb801.hlsl"
max r0.x, cb1[1].y, cb1[1].x
log r0.x, r0.x  // r0.x <- <Lod_id29 return value>

#line 153
mul r0.x, r0.x, cb0[1].x
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, v1.xyxx, t0.xyzw, s0, r0.x  // r0.x <- <Filter_id69 return value>.x; r0.y <- <Filter_id69 return value>.y; r0.z <- <Filter_id69 return value>.z; r0.w <- <Filter_id69 return value>.w
...
{
    return Texture0_id14.SampleLevel(LinearSampler_id44, streams.TexCoord_id62, Lod_id29(ViewSize_id77) * Compute_id71());
}
