...
//
#line 213 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_LambertianPrefilteringSHNoComputeEffectPass1_ddbe575fa8be8f02fbbb64754569d266.hlsl"
...
//
#line 185 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_LambertianPrefilteringSHNoComputeEffectPass1_ddbe575fa8be8f02fbbb64754569d266.hlsl"
...
void EvaluateSHBases_id15(inout PS_STREAMS streams, float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float3 uvToDirectionVS_id19(float u, float v, int viewIndex)
{
    if (viewIndex == 0)
        return float3(1, -v, -u);
    if (viewIndex == 1)
...
float4 Shading_id20(inout PS_STREAMS streams)
{
    ...
    {
        float3 dirVS = normalize(uvToDirectionVS_id19(uv.x, uv.y, faceIndex));
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    streams.ColorTarget_id10 = Shading_id20(streams);
