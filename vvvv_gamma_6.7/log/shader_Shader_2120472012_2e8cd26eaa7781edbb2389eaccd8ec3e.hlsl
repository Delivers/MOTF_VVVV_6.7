...
***** Compiler Parameters *****
***************************
@P EffectName: Shader_2120472012
***************************
****  ConstantBuffers  ****
***************************
cbuffer Inputs [Size: 16]
@C    input_1185577272_id37 => input_1185577272
@C    input_2025971261_id38 => input_2025971261
...
*****     Sources     *****
***************************
@S    Shader_2120472012 => 4dfd9ba6307ab4b68bb57b314026be23
...
//
#line 73 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_2120472012_2e8cd26eaa7781edbb2389eaccd8ec3e.hlsl"
...
@G    Pixel => 5903a7232241f7e646ded47372ed33bb
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   int input_1185577272_id37;         // Offset:    0 Size:     4
//   int input_2025971261_id38;         // Offset:    4 Size:     4
//
// }
//
//
...
//
#line 59 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_Shader_2120472012_2e8cd26eaa7781edbb2389eaccd8ec3e.hlsl"
...
cbuffer Inputs 
{
    int input_1185577272_id37;
    int input_2025971261_id38;
};
cbuffer PerDraw 
{
    float4x4 World_id24;
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    int result_1497179158 = (input_1185577272_id37 * input_2025971261_id38);
    float4 ToFloat_4078777503 = float4(result_1497179158, result_1497179158, result_1497179158, 1.0);
    streams.ColorTarget_id2 = ToFloat_4078777503;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    float4 mul_4075594818 = mul(streams.Position_id14, World_id24);
    streams.PositionWS_id15 = mul_4075594818;
    float4 mul_478111349 = mul(streams.Position_id14, WorldViewProjection_id29);
    streams.ShadingPosition_id0 = mul_478111349;
    float4 join_4054928082 = float4(streams.meshNormal_id32, 0);
    float4 mul_995763550 = mul(join_4054928082, WorldInverseTranspose_id26);
    float3 mulXyz_2114952311 = mul_995763550.xyz;
    streams.normalWS_id35 = mulXyz_2114952311;
