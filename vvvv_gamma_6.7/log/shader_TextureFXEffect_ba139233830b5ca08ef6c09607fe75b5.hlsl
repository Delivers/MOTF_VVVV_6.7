...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin HSCB_TextureFX [{Brightness = InputFloat<ShaderFX.InputValueFloat.i5,PerUpdate>}, {Contrast = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Hue = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {HueCycles = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Saturation = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {SaturationBalance = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}]
...
@P SaturationBalance: InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>
...
//
#line 238 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ba139233830b5ca08ef6c09607fe75b5.hlsl"
...
//
#line 155 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ba139233830b5ca08ef6c09607fe75b5.hlsl"
...
float4 Filter_id29(float4 tex0col)
{
    ...
    h.y = pow(h.y, pow(2, Compute_id31())) * Compute_id32();
    h.y = saturate(h.y);
    float3 k0 = HSLtoRGB_id10(float3((frac(h.x + Compute_id33()) - 0) * Compute_id34(), h.y, h.z));
    float3 k1 = HSLtoRGB_id10(float3((frac(h.x + Compute_id33()) - 1) * Compute_id34(), h.y, h.z));
    c.rgb = lerp(k0, k1, pow(smoothstep(0, 1, h.x), 2));
    c.rgb = normalize(c.rgb) * sqrt(3) * pow(length(c.rgb) / sqrt(3), pow(2, Compute_id35()));
    c.rgb *= pow(2, Compute_id36());
    return c;
}
