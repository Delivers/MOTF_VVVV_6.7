...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurGlow_Internal_TextureFX [{Brightness = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Radius = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Shape = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Shape: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Brightness: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
@C    Alpha_id91 => BlurGlow_Internal_TextureFX.Alpha
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    BlurGlow_Internal_TextureFX => 16c5f3b74a98493ec6116ae8424c19ff
...
//
#line 205 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_eff0bf69ed0dc65ad976258e87529579.hlsl"
...
@G    Pixel => 3112244dd5189d627cce50d80a625605
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Alpha_id91;                   // Offset:   80 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 184 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_eff0bf69ed0dc65ad976258e87529579.hlsl"
...
#line 167
mad r1.y, -cb0[1].y, r1.x, l(1.000000)
add r1.y, -r1.y, r1.x
...
#line 170
  mad r3.y, r1.w, cb0[1].z, -r1.x
  add r3.y, r3.y, l(1.000000)
  exp r3.y, r3.y
  mad r3.z, cb0[1].y, r1.x, -r1.w
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    for (float i = 0; i < min(lod - (1 - radius * lod), 14); i++)
    {
        ...
        float k = pow(2, i * Compute_id32() - lod + 1) * saturate(radius * lod - i + 1);
        col += nc * k;
        kk += k;
    }
    col /= kk;
    col.rgb *= Compute_id33();
    if (!Alpha_id91)
    {
