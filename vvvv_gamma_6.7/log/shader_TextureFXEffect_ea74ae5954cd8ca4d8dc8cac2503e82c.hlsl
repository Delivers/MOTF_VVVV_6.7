...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin HighPass_Internal_TextureFX [{Contrast = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]
@P Contrast: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
...
@C    Composite_id89 => HighPass_Internal_TextureFX.Composite
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    HighPass_Internal_TextureFX => 9e64def6dfc88ac4f57903c42f060045
...
//
#line 221 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ea74ae5954cd8ca4d8dc8cac2503e82c.hlsl"
...
@G    Pixel => 43c01929b21dd2e607fbb74ae05ea4f0
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Composite_id89;               // Offset:   80 Size:     4
//      = 0xffffffff 
//
// }
//
...
//
#line 200 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ea74ae5954cd8ca4d8dc8cac2503e82c.hlsl"
...
#line 163
div r1.xy, l(1.000000, 1.000000, 1.000000, 1.000000), cb1[1].xyxx  // r1.x <- step.x; r1.y <- step.y
...
#line 182
mov x1[7].x, l(-1.000000)

#line 183
mov x1[8].x, l(-1.000000)

#line 186
mov r1.xyzw, l(0,0,0,0)  // r1.x <- col.x; r1.y <- col.y; r1.z <- col.z; r1.w <- i
loop 
  ige r2.x, r1.w, l(9)
  breakc_nz r2.x
...
#line 188
  ...
  sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t0.xyzw, s0  // r2.x <- tmp.x; r2.y <- tmp.y; r2.z <- tmp.z

#line 189
  mov r2.w, x1[r1.w + 0].x
...
#line 191
mad r1.xyz, r1.xyzx, cb0[1].xxxx, l(0.500000, 0.500000, 0.500000, 0.000000)
...
movc r4.x, r2.x, r1.w, r3.x  // r4.x <- <overlay_id29 return value>; r4.x <- <overlay_id29 return value>
dp2 r1.w, r0.yyyy, r1.yyyy
movc r4.y, r2.y, r1.w, r3.y  // r4.y <- <overlay_id29 return value>; r4.y <- <overlay_id29 return value>
dp2 r1.w, r0.zzzz, r1.zzzz
movc r4.z, r2.z, r1.w, r3.z  // r4.z <- <overlay_id29 return value>

#line 195
movc r1.xyz, cb2[5].xxxx, r4.xyzx, r1.xyzx
...
float overlay_id29(float s, float d)
{
    return (d < 0.5) ? 2.0 * s * d : 1.0 - 2.0 * (1.0 - s) * (1.0 - d);
}
float3 overlay_id30(float3 s, float3 d)
{
    float3 c;
    c.x = overlay_id29(s.x, d.x);
    c.y = overlay_id29(s.y, d.y);
    c.z = overlay_id29(s.z, d.z);
    return c;
}
float Compute_id33()
{
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    for (int i = 0; i < 9; i++)
    {
        float4 tmp = Texture0_id14.Sample(LinearSampler_id44, uv + offset[i]);
        col += tmp.rgb * kernel[i];
    }
    col = col * Compute_id33() + 0.5;
    if (Composite_id89)
    {
        col = overlay_id30(col, tex0col.rgb);
    }
