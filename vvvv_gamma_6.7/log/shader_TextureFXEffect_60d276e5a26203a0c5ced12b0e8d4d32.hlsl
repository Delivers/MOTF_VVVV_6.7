...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin ShiftRGB_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Direction = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Hue = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Shift = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}]
@P Direction: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Shift: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P Hue: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
...
*****     Sources     *****
***************************
@S    ShiftRGB_Internal_TextureFX => 74b655a27f6152bd4169ce3b89e46722
...
//
#line 226 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_60d276e5a26203a0c5ced12b0e8d4d32.hlsl"
...
//
#line 152 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_60d276e5a26203a0c5ced12b0e8d4d32.hlsl"
...
{
    float2 dir = sin((Compute_id33() + float2(0, .25)) * 2 * acos(-1));
    uv += dir * offset;
    float3 col = tex2d.SampleLevel(Sampler0_id52, uv, 0).rgb;
    return float4(HSVtoRGB_id9(float3(Compute_id34(), 0, 0) + RGBtoHSV_id12(col)), 1);
}
float Compute_id35()
{
...
float4 Filter_id31(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float shift = Compute_id35();
    c.r = ts_id30(Texture0_id14, uv, shift * .1).r;
    c.g = ts_id30(Texture0_id14, uv, shift * 0).g;
    c.b = ts_id30(Texture0_id14, uv, shift * -.1).b;
    c.rgb = HSVtoRGB_id9(-float3(Compute_id34(), 0, 0) + RGBtoHSV_id12(c.rgb));
    return c;
}
