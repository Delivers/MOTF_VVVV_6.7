...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_969288627]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_969288627 => e096fd005de0e36ee0fc16f7da44003b
...
*****     Stages      *****
***************************
@G    Compute => d4778b28a30297e3a23735b00cc7dd12
//
...
// TextureInput_1117103150_id24      texture  float4          3d             t0      1 
// TextureInput_3584517380_id26      texture  float4          3d             t1      1 
// TextureInput_4178700741_id28      texture  float4          3d             t2      1 
...
//
#line 168 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_90e4f7868a77142d81eecb48e1e63a35.hlsl"
...
#line 187
  mov r1.w, l(1.000000)
  dp4 r2.x, r1.xyzw, cb0[2].xyzw  // r2.x <- mul_2209085358.x
  dp4 r2.y, r1.xyzw, cb0[3].xyzw  // r2.y <- mul_2209085358.y
  dp4 r2.z, r1.xyzw, cb0[4].xyzw  // r2.z <- mul_2209085358.z

#line 189
  add r2.xyz, r2.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)  // r2.x <- result_3364687112.x; r2.y <- result_3364687112.y; r2.z <- result_3364687112.z

#line 190
  sample_l_indexable(texture3d)(float,float,float,float) r2.xyz, r2.xyzx, t0.xyzw, s0, l(0.000000)  // r2.x <- textureNode_14368123.x; r2.y <- textureNode_14368123.y; r2.z <- textureNode_14368123.z
...
#line 244
  mov r1.w, l(1.000000)
  dp4 r7.x, r1.xyzw, cb0[18].xyzw  // r7.x <- mul_2445794550.x
  dp4 r7.y, r1.xyzw, cb0[19].xyzw  // r7.y <- mul_2445794550.y
  dp4 r7.z, r1.xyzw, cb0[20].xyzw  // r7.z <- mul_2445794550.z

#line 246
  add r6.xzw, r7.xxyz, l(0.500000, 0.000000, 0.500000, 0.500000)  // r6.x <- result_3128462620.x; r6.z <- result_3128462620.y; r6.w <- result_3128462620.z

#line 247
  sample_l_indexable(texture3d)(float,float,float,float) r7.xyzw, r6.xzwx, t1.xyzw, s1, l(0.000000)  // r7.x <- textureNode_2275827741.x; r7.y <- textureNode_2275827741.y; r7.z <- textureNode_2275827741.z; r7.w <- textureNode_2275827741.w
...
#line 289
  dp4 r7.x, r1.xyzw, cb0[28].xyzw  // r7.x <- mul_1287720271.x
  dp4 r7.y, r1.xyzw, cb0[29].xyzw  // r7.y <- mul_1287720271.y
  dp4 r7.z, r1.xyzw, cb0[30].xyzw  // r7.z <- mul_1287720271.z

#line 291
  add r0.yzw, r7.xxyz, l(0.000000, 0.500000, 0.500000, 0.500000)  // r0.y <- result_2379986923.x; r0.z <- result_2379986923.y; r0.w <- result_2379986923.z

#line 292
  sample_l_indexable(texture3d)(float,float,float,float) r7.xyzw, r0.yzwy, t2.xyzw, s2, l(0.000000)  // r7.x <- textureNode_509168628.x; r7.y <- textureNode_509168628.y; r7.z <- textureNode_509168628.z; r7.w <- textureNode_509168628.w
...
RWStructuredBuffer<Resource33157494> DynamicBufferInput_739794951_id23;
Texture3D<float4> TextureInput_1117103150_id24;
SamplerState SamplerInput_2972104104_id25;
Texture3D<float4> TextureInput_3584517380_id26;
SamplerState SamplerInput_2531627428_id27;
Texture3D<float4> TextureInput_4178700741_id28;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource33157494 getBuffer_1174292519 = DynamicBufferInput_739794951_id23[IndexX_2963031124];
