...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurMax_Pass0_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Width = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    BlurMax_Pass0_Internal_TextureFX => 0559796b087a1f75fdcb9362f3907a15
...
//
#line 194 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_2c7924f582d592db3202fda502e02156.hlsl"
...
@G    Pixel => 0586f45741fb7109178f5c9a7ea2f4a3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 157 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_2c7924f582d592db3202fda502e02156.hlsl"
...
#line 159
sample_l_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.xyxx, t0.xyzw, s0, r1.x
max r3.xyzw, r3.xyzw, l(0.000000, 0.000000, 0.000000, 0.000000)  // r3.x <- c.x; r3.y <- c.y; r3.z <- c.z; r3.w <- c.w

#line 160
max r2.xyzw, r2.xyzw, r3.xyzw  // r2.x <- c.x; r2.y <- c.y; r2.z <- c.z; r2.w <- c.w
...
#line 161
max r2.xyzw, r2.xyzw, r5.xyzw

#line 162
max r0.xyzw, r0.xyzw, r2.xyzw  // r0.x <- c.x; r0.y <- c.y; r0.z <- c.z; r0.w <- c.w

#line 163
max r0.xyzw, r4.xyzw, r0.xyzw
...
float4 Filter_id69(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float lod = Lod_id29(ViewSize_id77);
    lod = Compute_id71() * Lod_id29(ViewSize_id77);
    float4 c = 0;
    float2 off = .5 / ViewSize_id77 * pow(2, lod) * saturate(lod);
    lod -= 2;
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(0, 0) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(1, 1) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(1, -1) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(-1, -1) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(-1, 1) * off, lod));
    off *= 1.86;
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(0, 1) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(0, -1) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(-1, 0) * off, lod));
    c = max(c, Texture0_id14.SampleLevel(LinearSampler_id44, uv + float2(1, 0) * off, lod));
    return c;
}
