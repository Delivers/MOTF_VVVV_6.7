...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_395179192]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@S    Shader_395179192 => cbb05ca581728fb4360cbe5fc51ad60c
...
//
#line 84 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_6808752c849d5024d41cf196289dd4bb.hlsl"
...
RWStructuredBuffer<Resource5314558> DynamicBufferInput_1430151697_id12;
...
void Compute_id4(inout CS_STREAMS streams)
{
    ...
    Resource5314558 getBuffer_608833529 = DynamicBufferInput_1430151697_id12[IndexX_2325186706];
