...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BackgroundSubtraction_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Softness = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Threshold: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Softness: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
@C    Invert_id90 => BackgroundSubtraction_Internal_TextureFX.Invert
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    BackgroundSubtraction_Internal_TextureFX => ce31b41fc8b86f4c91fe9f8d087bf3a2
...
//
#line 190 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_3bf550f1f935d11ebdb0842b88e66124.hlsl"
...
@G    Pixel => 9de347e260ae73538b807d3041241c6f
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 160 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_3bf550f1f935d11ebdb0842b88e66124.hlsl"
...
#line 164
movc r1.w, cb1[5].x, r0.x, r0.z  // r1.w <- col.w
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    col.a = smoothstep(threshold, threshold + Compute_id32() + .000001, length(image.rgb - background.rgb));
    if (Invert_id90)
    {
        col.a = 1 - col.a;
    }
