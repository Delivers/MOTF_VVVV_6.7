...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Displace_Echo_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Fade = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Speed = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    Displace_Echo_Internal_TextureFX => aa30767119722038e167371f6d46d091
...
//
#line 181 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fa792124b68428643cb2ce2d9638bf39.hlsl"
...
@G    Pixel => 8fa6e74d162fb52cda63975f179d8530
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 154 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fa792124b68428643cb2ce2d9638bf39.hlsl"
div r0.xy, l(0.500000, 0.500000, 0.000000, 0.000000), cb1[1].xyxx
add r0.xy, r0.xyxx, v1.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r0.xy, r0.xyxx, t1.xyzw, s0, l(0.000000)  // r0.x <- dx.x; r0.y <- dx.y

#line 155
add r0.xy, r0.xyxx, -v1.xyxx
mad r0.xy, cb0[1].yyyy, r0.xyxx, v1.xyxx  // r0.x <- dx.x; r0.y <- dx.y
...
mov_sat r2.x, cb0[1].x
mad r0.xyzw, r2.xxxx, r1.xyzw, r0.xyzw  // r0.x <- <Filter_id29 return value>.x; r0.y <- <Filter_id29 return value>.y; r0.z <- <Filter_id29 return value>.z; r0.w <- <Filter_id29 return value>.w
...
{
    float2 dx = Texture1_id16.SampleLevel(LinearSampler_id44, streams.TexCoord_id62 + 0.5 / ViewSize_id77, 0).xy;
    dx = lerp(streams.TexCoord_id62, dx, Compute_id31());
    return lerp(Texture0_id14.SampleLevel(LinearSampler_id44, dx, 0), Texture2_id18.SampleLevel(LinearSampler_id44, dx, 0), saturate(Compute_id32()));
}
