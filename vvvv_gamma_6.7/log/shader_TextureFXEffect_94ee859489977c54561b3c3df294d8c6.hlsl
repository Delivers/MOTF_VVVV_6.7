...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin CrossStitch_Internal_TextureFX [{Color = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {StitchSize = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
@P Color: InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>
@P StitchSize: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
...
@C    Invert_id90 => CrossStitch_Internal_TextureFX.Invert
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    CrossStitch_Internal_TextureFX => 4e57af2cab075955991ef3e0a53493df
...
//
#line 210 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_94ee859489977c54561b3c3df294d8c6.hlsl"
...
@G    Pixel => afe5075c3db71b39eed150e038bd7163
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id93;             // Offset:   32 Size:     4
//
// }
//
// cbuffer PerView
...
//   bool Invert_id90;                  // Offset:   80 Size:     4
//      = 0x00000000 
//
// }
//
...
//
#line 189 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_94ee859489977c54561b3c3df294d8c6.hlsl"
...
#line 161
div r1.zw, r1.xxxy, cb0[2].xxxx
round_ni r1.zw, r1.zzzw  // r1.z <- tlPos.x; r1.w <- tlPos.y

#line 162
mul r1.zw, r1.zzzw, cb0[2].xxxx

#line 164
mul r2.xy, r1.xyxx, cb0[2].xxxx
ge r2.xy, r2.xyxx, -r2.xyxx
movc r2.xy, r2.xyxx, cb0[2].xxxx, -cb0[2].xxxx
...
#line 174
    mov r2.xyzw, cb0[1].xyzw  // r2.x <- col.x; r2.y <- col.y; r2.z <- col.z; r2.w <- col.w
  else   // Prior locations: r2.z <- blPos.y

#line 176
    mul r1.xy, r1.zwzz, cb2[0].xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t0.xyzw, s0, l(0.000000)  // r2.x <- col.x; r2.y <- col.y; r2.z <- col.z; r2.w <- col.w
  endif 
...
{
    float stitchSize = Compute_id32();
    float4 color = Compute_id31();
    float2 uv = streams.TexCoord_id62;
    float4 col = float4(0.0, 0.0, 0.0, 0.0);
    float size = stitchSize;
    float2 cPos = uv * ViewSize_id77;
    ...
    if ((remX == remY) || (((int(cPos.x) - int(blPos.x)) == (int(blPos.y) - int(cPos.y)))))
    {
        if (Invert_id90)
            ...
            col = Texture0_id14.SampleLevel(LinearRepeatSampler_id50, tlPos * Texture0TexelSize_id15, 0);
    }
    else
    {
        if (Invert_id90)
