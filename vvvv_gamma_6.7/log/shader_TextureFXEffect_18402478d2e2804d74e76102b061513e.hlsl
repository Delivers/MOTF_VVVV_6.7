...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Levels_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {FromBlack = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {FromWhite = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Gamma = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {ToBlack = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}, {ToWhite = InputFloat4<ShaderFX.InputValueFloat4_Color.i3,PerUpdate>}]
@P FromBlack: InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>
@P FromWhite: InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>
@P ToBlack: InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>
@P ToWhite: InputFloat4<ShaderFX.InputValueFloat4_Color.i3,PerUpdate>
...
@C    InputValue_id98 => ShaderFX.InputValueFloat4_Color.i2
@C    InputValue_id99 => ShaderFX.InputValueFloat4_Color.i3
...
@C    Type_id88 => Levels_Internal_TextureFX.Type
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Levels_Internal_TextureFX => e1ca2f4c7f04b6e6a2b6825e301d11c2
...
//
#line 238 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_18402478d2e2804d74e76102b061513e.hlsl"
...
@G    Pixel => 292cfbe81ca81995b80e7a0f08b13aee
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id95;            // Offset:   16 Size:    16
//   float4 InputValue_id96;            // Offset:   32 Size:    16
//   float InputValue_id97;             // Offset:   48 Size:     4
//   float4 InputValue_id98;            // Offset:   64 Size:    16
//   float4 InputValue_id99;            // Offset:   80 Size:    16
//
// }
//
// cbuffer Globals
...
//
#line 217 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_18402478d2e2804d74e76102b061513e.hlsl"
...
#line 191
add r1.xyzw, -cb0[1].xyzw, cb0[2].xyzw  // r1.x <- fromDelta.x; r1.y <- fromDelta.y; r1.z <- fromDelta.z; r1.w <- fromDelta.w

#line 192
add r2.xyzw, r0.xyzw, -cb0[1].xyzw  // r2.x <- cMin.x; r2.y <- cMin.y; r2.z <- cMin.z; r2.w <- cMin.w
...
#line 212
add r2.xyzw, -cb0[4].xyzw, cb0[5].xyzw
mad r1.xyzw, r1.xyzw, r2.xyzw, cb0[4].xyzw
...
{
    float4 fromBlack = Compute_id35();
    float4 fromWhite = Compute_id36();
    float4 toBlack = Compute_id37();
    float4 toWhite = Compute_id38();
    float4 c = tex0col;
    float4 fromDelta = fromWhite - fromBlack;
    float4 cMin = c - fromBlack;
    c = cMin / fromDelta;
    c = isnan(c) ? cMin : c;
    c = sign(c) * pow(abs(c), Compute_id39());
    switch (Type_id88)
