...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_FromTexture_Internal_TextureFX [{Brightness = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Color = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Scale = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}]
@P Color: InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>
@P Brightness: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Scale: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
*****     Sources     *****
***************************
@S    Hatch_FromTexture_Internal_TextureFX => db37313f881d20dc9ed9b2f6c93430b4
...
//
#line 215 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_f48a420dbde7cfcecc75891eacde7195.hlsl"
...
@G    Pixel => 6306ab9e5aefe59328de98c075ed01d2
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 161 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_f48a420dbde7cfcecc75891eacde7195.hlsl"
mad r0.xy, v1.xyxx, cb1[1].xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)  // r0.x <- x.x; r0.y <- x.y

#line 165
mul r0.z, cb0[3].x, l(0.500000)
...
#line 177
mad r3.xy, r1.wwww, cb0[1].xxxx, l(-0.666000, -0.333000, 0.000000, 0.000000)
...
#line 199
mad r1.xyzw, r2.xyzw, cb0[2].xyzw, -r0.xyzw
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    c *= Compute_id32();
    float3 col2 = Texture1_id16.SampleLevel(LinearRepeatSampler_id50, x * (Compute_id33() / 2.0), 0).rgb;
    float g0 = 0;
    float g1 = 0;
    float f = 0;
    if (c >= 0.666)
    ...
    float g = g0 + f * (g1 - g0);
    g = 1 - g;
    col = float4(g, g, g, col.a) * Compute_id31();
    return col;
}
