...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Erode_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {MaxThreshold = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {MinThreshold = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Separation = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@C    Size_id88 => Erode_Internal_TextureFX.Size
@C    Shape_id92 => Erode_Internal_TextureFX.Shape
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    Erode_Internal_TextureFX => 15dd760407ec2f30599f3a1091d24b1e
...
//
#line 230 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7bedb696ca88758bc66bd3502d15ebc3.hlsl"
...
@G    Pixel => bd2016922c7e27239c6f00a30ed7b818
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 209 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7bedb696ca88758bc66bd3502d15ebc3.hlsl"
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    for (int i = -Size_id88; i <= Size_id88; ++i)
    {
        ...
        for (int j = -Size_id88; j <= Size_id88; ++j)
        {
            ...
            if (!skip)
            {
                float4 c = Texture0_id14.SampleLevel(Sampler0_id52, streams.TexCoord_id62 + float2(i, j) * Compute_id31() / texSize, 0);
    ...
    return float4(lerp(cmx.rgb, tex0col.rgb, smoothstep(Compute_id32(), Compute_id33(), mx)), tex0col.a);
}
