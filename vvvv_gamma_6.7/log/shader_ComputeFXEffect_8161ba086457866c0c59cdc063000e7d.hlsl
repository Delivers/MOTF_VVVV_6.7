...
@P EffectNodeBase.EffectNodeBaseShader: mixin SpatialHash_BitonicSort_ComputeFX
***************************
****  ConstantBuffers  ****
***************************
cbuffer cb [Size: 16]
@C    _Level_id11 => SpatialHash_BitonicSort_ComputeFX._Level
@C    _LevelMask_id12 => SpatialHash_BitonicSort_ComputeFX._LevelMask
***************************
******  Resources    ******
***************************
@R    Data0_id13 => SpatialHash_BitonicSort_ComputeFX.Data0 [Stage: Compute, Slot: (0-0)]
@R    cb => cb [Stage: Compute, Slot: (0-0)]
***************************
*****     Sources     *****
***************************
@S    ComputeShaderBase => 8f045851eaa4513eb38a704d53889e6d
@S    SpatialHash_BitonicSort_ComputeFX => 53c0119fb6ea2821ab056887fa74d5c1
***************************
*****     Stages      *****
***************************
@G    Compute => 802c67e2b4d76328828bf8b8db4320a4
//
...
//
#line 41 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_ComputeFXEffect_8161ba086457866c0c59cdc063000e7d.hlsl"
...
#line 46
  ld_structured r1.xy, l(0), l(0), g0.xyxx
  ld_structured r1.zw, r0.z, l(0), g0.xxxy

#line 35
  ieq r0.w, r1.z, r1.x
  uge r1.zw, r1.wwwz, r1.yyyx
  movc r0.w, r0.w, r1.z, r1.w  // r0.w <- <Compare_id2 return value>

#line 46
  ieq r0.w, r0.y, r0.w
  xor r1.z, r0.z, l(0)
  ld_structured r1.zw, r1.z, l(0), g0.xxxy
  movc r1.xy, r0.wwww, r1.zwzz, r1.xyxx  // r1.x <- result.x; r1.y <- result.y
...
cbuffer Globals 
{
    groupshared uint2 shared_data_id14[512];
};
RWStructuredBuffer<uint2> Data0_id13;
bool Compare_id2(uint2 left, uint2 right)
{
...
void Compute_id3(inout CS_STREAMS streams)
{
    ...
    {
        uint2 result = Compare_id2(shared_data_id14[GI & ~j], shared_data_id14[GI | j]) == (bool)(_LevelMask_id12 & DTid.x) ? shared_data_id14[GI ^ j] : shared_data_id14[GI];
        GroupMemoryBarrierWithGroupSync();
