...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin AutoColor_Pass0_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Fade = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Power = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@C    Reset_id90 => AutoColor_Pass0_Internal_TextureFX.Reset
***************************
******  Resources    ******
***************************
...
*****     Sources     *****
***************************
@S    AutoColor_Pass0_Internal_TextureFX => af39c90ddec86083754c428382c2d7b3
...
//
#line 190 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ded2072d41dc34b06af8579af510b3f7.hlsl"
...
@G    Pixel => e021f52abe818b08207ad6ab88c6da67
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   bool Reset_id90;                   // Offset:   80 Size:     4
//
// }
//
//
...
//
#line 162 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ded2072d41dc34b06af8579af510b3f7.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xy, v1.xyxx, t1.xyzw, s0, l(0.000000)  // r0.x <- pre.x; r0.y <- pre.y

#line 163
log r0.x, r0.x
div r0.z, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[1].y
mul r0.x, r0.x, r0.z
exp r0.x, r0.x
...
exp r0.z, r0.z
add r0.x, -r0.z, r0.x
mad r0.x, cb0[1].x, r0.x, r0.z
log r0.x, r0.x
mul r0.x, r0.x, cb0[1].y
exp r2.x, r0.x  // r2.x <- c.x

#line 174
mov r2.z, l(0)

#line 164
movc r0.x, cb1[5].x, l(0), cb0[1].x

#line 160
dp3 r0.z, r1.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)

#line 164
mad r0.y, -r0.z, l(0.333333), r0.y

#line 160
mul r0.z, r0.z, l(0.333333)  // r0.z <- c.y

#line 164
mad r2.y, r0.x, r0.y, r0.z  // r2.y <- c.y
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    float4 u = tex0col;
    float4 c = tex0col;
    float power = Compute_id31();
    float fade = Compute_id32();
    c.x = pow(max(u.r, max(u.g, u.b)), power);
    c.y = dot(u.rgb, 1.0) / 3.0;
    c.z = 0;
    float4 pre = Texture1_id16.SampleLevel(LinearSampler_id44, streams.TexCoord_id62, 0);
    c.x = pow(lerp(pow(c.x, 1.0 / power), pow(pre.x, 1.0 / power), fade), power);
    c.y = lerp(c.y, pre.y, fade * !Reset_id90);
    return c;
}
