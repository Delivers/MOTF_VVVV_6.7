...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Wave_Display_Internal_TextureFX [{BackgroundColor = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {WaveColor = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}]
@P BackgroundColor: InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>
@P WaveColor: InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>
...
*****     Sources     *****
***************************
@S    Wave_Display_Internal_TextureFX => df276b5e242d4ecbca252cfbe15c2153
...
//
#line 185 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_07bb98b2a47b986abd643dd3ce0cd8b0.hlsl"
...
@G    Pixel => 90af1384566fce9d5868d8e4e854d18d
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 159 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_07bb98b2a47b986abd643dd3ce0cd8b0.hlsl"
...
mov r0.y, l(1.000000)
mad r0.xyzw, r0.xxxy, r1.xyzw, cb0[1].xyzw  // r0.x <- <Filter_id69 return value>.x; r0.y <- <Filter_id69 return value>.y; r0.z <- <Filter_id69 return value>.z; r0.w <- <Filter_id69 return value>.w
...
{
    float3 c = GetLuminance_id34(Texture0_id14.SampleLevel(LinearSampler_id44, streams.TexCoord_id62, 0).rgb);
    return lerp(Compute_id71(), Compute_id72(), float4(c, 1.0));
}
