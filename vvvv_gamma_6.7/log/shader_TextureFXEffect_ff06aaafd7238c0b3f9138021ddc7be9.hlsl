...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Tiles_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {FactorXY = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]
@P FactorXY: InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>
...
@C    InputValue_id90 => ShaderFX.InputValueFloat2
...
*****     Sources     *****
***************************
@S    Tiles_Internal_TextureFX => d1fa6e4bbb06004c7f1fd515a4a80a9f
...
//
#line 176 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ff06aaafd7238c0b3f9138021ddc7be9.hlsl"
...
@G    Pixel => 699a789dfdf0597b1edff65693831657
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id90;            // Offset:   16 Size:     8
//
// }
//
// cbuffer PerView
...
//
#line 150 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_ff06aaafd7238c0b3f9138021ddc7be9.hlsl"
div r0.xy, l(0.500000, 0.500000, 0.000000, 0.000000), cb1[1].xyxx
max r0.xy, r0.xyxx, cb0[1].xyxx
min r0.xy, r0.xyxx, cb1[1].xyxx
div r0.xy, cb1[1].xyxx, r0.xyxx  // r0.x <- sz.x; r0.y <- sz.y

#line 151
add r0.zw, v1.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
mad r0.zw, r0.zzzw, r0.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
...
float4 Filter_id29(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float2 sz = ViewSize_id77 / min(max(0.5 / ViewSize_id77, Compute_id31()), ViewSize_id77);
    return Texture0_id14.SampleLevel(Sampler0_id52, lerp(uv, (round((uv - 0.5) * sz - 0.5) + 0.5) / sz + 0.5, 1), 0);
}
