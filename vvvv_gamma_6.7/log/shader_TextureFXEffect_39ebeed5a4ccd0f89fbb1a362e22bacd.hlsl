...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Hatch_Square_Internal_TextureFX [{BackgroundColor = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {HatchColor = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}, {Rotation = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}, {Thickness = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Threshold = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
@P Thickness: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
@P Rotation: InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>
...
*****     Sources     *****
***************************
@S    Hatch_Square_Internal_TextureFX => fe1a0ef94c9b4dfa940fa26023e35263
...
//
#line 203 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_39ebeed5a4ccd0f89fbb1a362e22bacd.hlsl"
...
@G    Pixel => 0e70a7c442bd028a1986cd43ab0b7b96
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id102;            // Offset:   48 Size:     4
//   float InputValue_id103;            // Offset:   52 Size:     4
//   float InputValue_id104;            // Offset:   56 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 177 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_39ebeed5a4ccd0f89fbb1a362e22bacd.hlsl"
mad r0.xy, v1.yxyy, cb1[1].yxyy, l(-0.500000, -0.500000, 0.000000, 0.000000)

#line 161
sincos r1.x, r2.x, cb0[3].x

#line 162
mul r0.zw, r0.xxxy, r1.xxxx

#line 161
mad r1.x, r2.x, r0.y, r0.z  // r1.x <- x

#line 162
mad r1.y, r2.x, r0.x, -r0.w  // r1.y <- y

#line 178
add r0.xy, r1.xyxx, cb1[1].xyxx
mul r0.zw, r0.xxxy, cb0[3].yyyy
ge r0.zw, r0.zzzw, -r0.zzzw
movc r0.zw, r0.zzzw, cb0[3].yyyy, -cb0[3].yyyy
...
#line 176
sqrt r0.zw, r1.xxxy  // r0.z <- col.x; r0.w <- col.y

#line 178
mul r0.zw, r0.zzzw, cb0[3].zzzz
lt r0.xy, r0.xyxx, r0.zwzz
or r0.x, r0.y, r0.x
and r0.x, r0.x, l(0x3f800000)
add r2.xyzw, -cb0[1].xyzw, cb0[2].xyzw
mad r0.xyzw, r0.xxxx, r2.xyzw, cb0[1].xyzw
mov r2.x, l(1.000000)
mov r2.w, r1.w
...
float4 Filter_id69(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float2 rotated = r2d_id58(streams.TexCoord_id62 * ViewSize_id77 - 0.5, Compute_id73());
    return lerp(Compute_id71(), Compute_id72(), any(((rotated + ViewSize_id77)) % Compute_id74() < col.rgb * Compute_id75())) * float4(1.0, 1.0, 1.0, col.a);
}
