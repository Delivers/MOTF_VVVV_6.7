...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlurNoMips_Internal_TextureFX [{Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Strength = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]
...
*****     Sources     *****
***************************
@S    BlurNoMips_Internal_TextureFX => ef43f449f5164ee10740e92989fa2516
...
//
#line 196 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fb424608a9b5cd7351f9e9728d00b268.hlsl"
...
@G    Pixel => 17270605be75660d474036f3eec92105
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 142 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_fb424608a9b5cd7351f9e9728d00b268.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, v1.xyxx, t0.xyzw, s0, l(0.000000)  // r0.x <- c.x; r0.y <- c.y; r0.z <- c.z; r0.w <- c.w
...
#line 143
mad r1.yz, r2.zzwz, r1.xxxx, v1.xxyx
sample_l_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.yzyy, t0.xyzw, s0, l(0.000000)
add r0.xyzw, r0.xyzw, r3.xyzw

#line 170
mul r3.xyzw, r1.xxxx, r2.xyzw  // r3.z <- off.x; r3.w <- off.y

#line 145
mad r1.xy, -r2.zwzz, r1.xxxx, v1.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s0, l(0.000000)

#line 146
mad r2.xyzw, r3.zwzw, l(1.000000, -1.000000, -1.000000, 1.000000), v1.xyxy
...
#line 149
mad r1.xyzw, r3.zwzw, l(0.000000, 1.860000, 0.000000, -1.860000), v1.xyxy

#line 151
mad r2.xyzw, r3.xyzw, l(-1.860000, 0.000000, 1.860000, 0.000000), v1.xyxy
...
{
    float lod = Compute_id73() * Lod_id29(ViewSize_id77);
    float2 off = 1.0 / ViewSize_id77 * pow(2, lod);
    return BlurPass_id70(Texture0_id14, LinearSampler_id44, streams.TexCoord_id62, off, 0);
}
