...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Garbage_Internal_TextureFX [{Alpha = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}, {Control = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}, {Offset = InputFloat2<ShaderFX.InputValueFloat2.i1,PerUpdate>}, {Rotate = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}, {Scale = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]
@P Rotate: InputFloat<ShaderFX.InputValueFloat,PerUpdate>
@P Alpha: InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>
...
*****     Sources     *****
***************************
@S    Garbage_Internal_TextureFX => 050ed598dca6e892a1a6a4588fec4104
...
//
#line 199 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7454444e69f36380f709419f12907760.hlsl"
...
@G    Pixel => fe09044470c0f5a2570ba4a6f59e2931
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id96;            // Offset:   32 Size:     8
//
// }
//
//
...
//
#line 171 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_TextureFXEffect_7454444e69f36380f709419f12907760.hlsl"
exp r0.xy, cb0[2].xyxx

#line 156
mul r0.z, cb0[1].w, l(6.283185)  // r0.z <- a

#line 157
sincos r1.x, r2.x, r0.z

#line 171
add r0.zw, v1.yyyx, l(0.000000, 0.000000, -0.500000, -0.500000)  // r0.z <- x.y; r0.w <- x.x

#line 157
mul r1.xy, r0.zwzz, r1.xxxx
mad r3.x, r2.x, r0.w, r1.x  // r3.x <- <r2d_id29 return value>.x
mad r3.y, r2.x, r0.z, -r1.y  // r3.y <- <r2d_id29 return value>.y

#line 171
mad r0.xy, r3.xyxx, r0.xyxx, cb0[1].yzyy
add r0.xy, r0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)  // r0.x <- dx.x; r0.y <- dx.y

#line 172
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t1.xyzw, s0, l(0.000000)  // r0.x <- pre.x; r0.y <- pre.y; r0.z <- pre.z; r0.w <- pre.w
...
mad r2.xyz, r2.wwww, r2.xyzx, r0.xyzx  // r2.x <- c.x; r2.y <- c.y; r2.z <- c.z
add r2.w, r0.w, r1.w  // r2.w <- c.w
...
float4 Filter_id30(inout PS_STREAMS streams, float4 tex0col)
{
    ...
    float4 c = tex0col;
    float2 dx = r2d_id29(uv - 0.5, Compute_id32()) * pow(2, Compute_id34()) + 0.5 + Compute_id35();
    float4 pre = Texture1_id16.SampleLevel(LinearSampler_id44, dx, 0);
    c = float4(lerp(pre, c, lerp(1, c.a, Compute_id33())).rgb, pre.a + c.a);
    return c;
}
