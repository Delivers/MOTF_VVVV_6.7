...
//
#line 224 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_RadiancePrefilteringGGXNoComputeEffect_6d91582fda719e24aff52abfbade421d.hlsl"
...
//
#line 172 "C:\Users\sw\Documents\_projects\2024\MOTF\MOTF_VVVV_6.7\vvvv_gamma_6.7\log\shader_RadiancePrefilteringGGXNoComputeEffect_6d91582fda719e24aff52abfbade421d.hlsl"
if_nz cb0[5].w
...
#line 182
    ...
    mov r1.z, l(-1.000000)
    and r1.xyz, r0.wwww, r1.xyzx  // r1.x <- <ConvertTexcoordsNoFlip_id19 return value>.x; r1.y <- <ConvertTexcoordsNoFlip_id19 return value>.y; r1.z <- <ConvertTexcoordsNoFlip_id19 return value>.z
    ...
    mov r2.y, l(-1.000000)
    movc r0.yzw, r0.yyyy, r2.xxyz, r1.xxyz  // r0.y <- <ConvertTexcoordsNoFlip_id19 return value>.x; r0.z <- <ConvertTexcoordsNoFlip_id19 return value>.y; r0.w <- <ConvertTexcoordsNoFlip_id19 return value>.z
    mad r1.xz, v1.xxyx, l(2.000000, 0.000000, 2.000000, 0.000000), l(-1.000000, 0.000000, -1.000000, 0.000000)
    mov r1.y, l(1.000000)
    movc r0.xyz, r0.xxxx, r1.xyzx, r0.yzwy  // r0.x <- <ConvertTexcoordsNoFlip_id19 return value>.x; r0.y <- <ConvertTexcoordsNoFlip_id19 return value>.y; r0.z <- <ConvertTexcoordsNoFlip_id19 return value>.z
  else 
    mov r0.x, l(-1.000000)
    mad r0.yz, v1.yyxy, l(0.000000, -2.000000, 2.000000, 0.000000), l(0.000000, 1.000000, -1.000000, 0.000000)  // r0.x <- <ConvertTexcoordsNoFlip_id19 return value>.x; r0.y <- <ConvertTexcoordsNoFlip_id19 return value>.y; r0.z <- <ConvertTexcoordsNoFlip_id19 return value>.z
  endif 
else 
  mov r0.x, l(1.000000)
  mad r0.yz, v1.yyxy, l(0.000000, -2.000000, -2.000000, 0.000000), l(0.000000, 1.000000, 1.000000, 0.000000)  // r0.x <- <ConvertTexcoordsNoFlip_id19 return value>.x; r0.y <- <ConvertTexcoordsNoFlip_id19 return value>.y; r0.z <- <ConvertTexcoordsNoFlip_id19 return value>.z
...
#line 152
  ...
  mad r5.xyz, r0.xyzx, r4.zzzz, r5.xyzx  // r5.x <- <GetSample_id21 return value>.x; r5.y <- <GetSample_id21 return value>.y; r5.z <- <GetSample_id21 return value>.z
...
#line 137
    ...
    div r4.z, r1.x, r4.z  // r4.z <- <NormalDistributionGGX_id22 return value>
...
float NormalDistributionGGX_id22(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    float d = max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001);
    return alphaR2 / (PI_id0 * d * d);
}
float3 GetSample_id21(float2 xi, float roughness, float3 N)
{
...
float2 GetSamplePlane_id20(int k, int samplesCount)
{
    float u = 0.0;
    float p = 0.5;
...
float3 ConvertTexcoordsNoFlip_id19(float2 inputTexcoord, int viewIndex)
{
...
{
    float3 R = normalize(ConvertTexcoordsNoFlip_id19(streams.TexCoord_id63, Face_id80));
    float4 prefilteredSample = 0;

    for (int sampleIndex = 0; sampleIndex < TNbOfSamples_id75; sampleIndex++)
    {
        float2 xi = GetSamplePlane_id20(sampleIndex, TNbOfSamples_id75);
        float3 H = GetSample_id21(xi, Roughness_id79, R);
        float3 L = 2 * dot(R, H) * H - R;
        float NoL = saturate(dot(R, L));
        float pdf = NormalDistributionGGX_id22(Roughness_id79 * Roughness_id79, NoL) / 4;
...
PS_OUTPUT PSMain(PS_INPUT __input__)
{
    ...
    streams.ColorTarget_id3 = Shading_id18(streams);
